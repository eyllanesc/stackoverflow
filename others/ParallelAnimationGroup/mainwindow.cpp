    ...
    ui(new Ui::MainWindow)
{
    ...
    for (int i = 0; i < 10 ; i += 1) {
        ...
        if (i > anchorID) {
           anim->setEndValue(QPointF(40 + spaceWidth * (i) + colWidth * (i - 1), ui->graphicsView->height() - 40));
        } else {
           anim->setEndValue(QPointF(40 + spaceWidth * (i + 1) + colWidth * (i), ui->graphicsView->height() - 40));
        }
