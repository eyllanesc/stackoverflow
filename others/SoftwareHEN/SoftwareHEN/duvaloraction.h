...
public:
  ...
  friend QDataStream &operator<<(QDataStream &out,
                                 const Duvaloraction &valoraction);
...
class Operaciones {
public:
  Operaciones(int tabval, int method, int analisis, int dtmin, int maximo,
              int minimo, int k, QVector<QVector<double>> Matriz);
  void operaciones(int tipo, int method, int analisis, int dtmin, int maximo,
                   int minimo, int k, QVector<QVector<double>> Matriz);
