...
int main(int argc, char *argv[]) {
  ...
  // QObject::connect(&fourth, SIGNAL(subwindow(int)),&second,
  // SLOT(subwindowVALUE(int))); QObject::connect(&fourth,
  // SIGNAL(newSignalSIS(bool)),&second, SLOT(OnnewSignalSIS(bool)));
