...
FocusLabel::FocusLabel(QWidget *parent, const QString &str)
    : QLabel(str, parent) {
...
void FocusLabel::enableZoom(bool value) { m_zoomEnabled = value; }

double FocusLabel::fontSize() const { return m_fontSize; }
