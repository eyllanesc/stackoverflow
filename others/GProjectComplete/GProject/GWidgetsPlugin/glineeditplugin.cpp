...
GLineEditPlugin::GLineEditPlugin(QObject *parent) : QObject(parent) {
  m_initialized = false;
}
...
bool GLineEditPlugin::isInitialized() const { return m_initialized; }

QWidget *GLineEditPlugin::createWidget(QWidget *parent) {
  return new GLineEdit(parent);
}

QString GLineEditPlugin::name() const { return QLatin1String("GLineEdit"); }

QString GLineEditPlugin::group() const {
  return QLatin1String("Google-Styled Widgets");
}

QIcon GLineEditPlugin::icon() const { return QIcon(); }

QString GLineEditPlugin::toolTip() const { return QLatin1String(""); }

QString GLineEditPlugin::whatsThis() const { return QLatin1String(""); }

bool GLineEditPlugin::isContainer() const { return false; }

QString GLineEditPlugin::domXml() const {
  return QLatin1String(
      "<widget class=\"GLineEdit\" name=\"gLineEdit\">\n</widget>\n");
}
