...
void MainWindow::on_actionOpen_triggered() {
  QString FileName = QFileDialog::getOpenFileName(
      this, "Open File", "D:/imgDemo",
      "*.* All Files;;*.bmp;;*.jpeg;;*.jpeg;;*.ppm;;*.png;;*.jpg");
...
void MainWindow::on_actionOil_Paint_triggered() {
  ...
  if (!activeWindow)
    return;
  ImageWidget *activeWidget =
      qobject_cast<ImageWidget *>(activeWindow->widget());
  QImage img_in = activeWidget->image();
  int intensity = QInputDialog::getInt(
      this, "", QString::fromUtf8("Please input Intensity Level"), 3, 1, 100,
      1);
  int radius = QInputDialog::getInt(
      this, "", QString::fromUtf8("Please input Radius"), 0, 1, 100, 1);
