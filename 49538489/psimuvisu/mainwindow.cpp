...
//                     SLOT(this->rubberZoomAdapt(QPointF fp, QPointF tp)));
    ...
    QObject::connect(ui->bSignalTest,
                     &QPushButton::clicked,
                     this,
...
void MainWindow::rubberZoomAdapt(QPointF fp, QPointF tp)
{
    ...
    qDebug() << "(rubberZoomAdapt) RubberBand Event: fp: " << fp << "; tp: " << tp;
...
bool MainWindow::eventFilter(QObject *watched, QEvent *event)
{
    ...
    {
        qDebug() << "(eventFilter) EventFilter: RubberBand: " << QString::number(i++);
//        QPointF fp = this->chart->mapToValue(this->qRubberBand->geometry().topLeft());
//        QPointF tp = this->chart->mapToValue(this->qRubberBand->geometry().bottomRight());
