...
class MainWindow(QtWidgets.QMainWindow):
	def __init__(self, url):
		...
		toolBar.addAction(self.view.pageAction(QtWebEngineWidgets.QWebEnginePage.Back))
		toolBar.addAction(self.view.pageAction(QtWebEngineWidgets.QWebEnginePage.Forward))
		toolBar.addAction(self.view.pageAction(QtWebEngineWidgets.QWebEnginePage.Reload))
		toolBar.addAction(self.view.pageAction(QtWebEngineWidgets.QWebEnginePage.Stop))
		...
		self.rotateAction.setIcon(self.style().standardIcon(QtWidgets.QStyle.SP_FileDialogDetailedView))
		...
		toolsMenu.addAction(self.tr("Remove all inline frames"), self.removeInlineFrames)
		toolsMenu.addAction(self.tr("Remove all object elements"), self.removeObjectElements)
		toolsMenu.addAction(self.tr("Remove all embedded elements"), self.removeEmbeddedElements)
	...
	def adjustTitle(self):
		if self.progress <= 0 or self.progress >= 100:
			...
			self.setWindowTitle("{} ({}%)".format(self.view.title(), self.progress))
