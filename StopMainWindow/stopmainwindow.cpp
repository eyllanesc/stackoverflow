    ...
    ui(new Ui::StopMainWindow)
{
    ...
    connect(ui->pushButton_Start, &QPushButton::clicked, this, &StopMainWindow::start);
    connect(ui->pushButton_go_on, &QPushButton::clicked, this, &StopMainWindow::pause);
    connect(ui->pushButton_Stop, &QPushButton::clicked, this, &StopMainWindow::stop);
