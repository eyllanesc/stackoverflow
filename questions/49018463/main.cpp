...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(rectQuickItem, &QQuickItem::xChanged, [rectQuickItem, rectQuickItemParent]{
        qDebug()<<positionToParent(rectQuickItem);
        qDebug()<<positionToAnotherItem(rectQuickItem, rectQuickItemParent);
    });

    QObject::connect(rectQuickItem, &QQuickItem::yChanged, [rectQuickItem, rectQuickItemParent]{
        qDebug()<<positionToParent(rectQuickItem);
        qDebug()<<positionToAnotherItem(rectQuickItem, rectQuickItemParent);
    });
