...
static bool createConnection()
{
    ...
    QSqlQuery query;
    if(!query.exec("create table traffic (date DATE default CURRENT_DATE,  sent INTEGER, recv INTEGER)")){
...
int main(int argc, char *argv[])
{
    ...
    if(!createConnection())
        return -1;
    qmlRegisterType<SqlTrafficModel>("com.eyllanesc.models", 1, 0, "SqlTrafficModel");
