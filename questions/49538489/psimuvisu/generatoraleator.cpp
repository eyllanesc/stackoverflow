...
void GeneratorAleator::setMax(float max)
{
    GeneratorAleator::max = max;
}

void GeneratorAleator::setMin(float min)
{
    GeneratorAleator::min = min;
}
