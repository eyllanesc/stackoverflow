            ...
            object[signalName] = {
              connect : function(callback) {
                ...
                if (!isPropertyNotifySignal && signalName !== "destroyed") {
                  ...
                  // properties in propertyUpdate also note that we always get
                  // notified about the destroyed signal
                  webChannel.exec({
          ...
          function invokeSignalCallbacks(signalName, signalArgs) {
            ...
            if (connections) {
              connections.forEach(function(
                  callback) { callback.apply(callback, signalArgs); });
            }
          }
                    ...
                    object[methodName] = function() {
                      ...
                      for (var i = 0; i < arguments.length; ++i) {
                        ...
                        if (typeof argument === "function")
                          callback = argument;
                        else if (argument instanceof QObject &&
                                 webChannel.objects[argument.__id__] !==
                                     undefined)
                  ...
                  function bindGetterSetter(propertyInfo) {
                    ...
                    Object.defineProperty(object, propertyName, {
                      ...
                      set : function(value) {
                        ...
                        if (valueToSend instanceof QObject &&
                            webChannel.objects[valueToSend.__id__] !==
                                undefined)
