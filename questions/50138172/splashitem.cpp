...
SplashItem::SplashItem(QObject *parent): QObject(parent)
{
    ...
    connect(m_animation, &QPropertyAnimation::finished, this, &SplashItem::onFinished);
    connect(m_animation, &QPropertyAnimation::valueChanged, this, &SplashItem::verifyCollide);
}
