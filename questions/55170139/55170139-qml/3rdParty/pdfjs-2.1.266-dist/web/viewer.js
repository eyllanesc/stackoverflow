  ...
  /******/ if (mode & 2 && typeof value != 'string')
    for (var key in value)
      __webpack_require__.d(
          ns, key, function(key) { return value[key]; }.bind(null, key));
  /******/ return ns;
/******/
};
/******/
...
/******/
    ...
    /******/ ([
          ...
          return {
            ...
            documentProperties : {
              ...
              fields : {
                ...
                'modificationDate' :
                    document.getElementById('modificationDateField'),
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", {value : true});
        exports.PDFPrintServiceFactory = exports.DefaultExternalServices =
            exports.PDFViewerApplication = void 0;
        ...
        var ViewOnLoad = {UNKNOWN : -1, PREVIOUS : 0, INITIAL : 1};
        var DefaultExternalServices = {
          ...
          createL10n : function createL10n(
              options) { throw new Error('Not implemented: createL10n'); },
        ...
        var PDFViewerApplication = {
                    ...
                    while (1) {
                      ...
                      case 8:
                        if (this.isViewerEmbedded &&
                          ...
                          _app_options.AppOptions.set('externalLinkTarget',
                        ...
                        while (1) {
                          ...
                          case 2:
                            ...
                            if ('verbosity' in hashParams) {
                              _app_options.AppOptions.set(
                                  'verbosity', hashParams['verbosity'] | 0);
                            }
                          ...
                          case 20:
                            ...
                            viewer.classList.add('textLayer-' +
          ...
          _initializeViewerComponents : function() {
            var _initializeViewerComponents2 = _asyncToGenerator(
                ...
                _regenerator.default.mark(function _callee5() {
                  var appConfig, dispatchToDOM, eventBus, pdfRenderingQueue,
                      pdfLinkService, downloadManager, findController,
                      container, viewer, thumbnailContainer, sidebarConfig;
                  return _regenerator.default
                      .wrap(function _callee5$(_context5) {
                        while (1) {
                          ...
                          case 0:
                            ...
                            eventBus =
                                appConfig.eventBus ||
                                (0, _ui_utils.getGlobalEventBus)(dispatchToDOM);
                            ...
                            pdfLinkService =
                                new _pdf_link_service.PDFLinkService({
                                  eventBus : eventBus,
                                  externalLinkTarget :
                                      _app_options.AppOptions.get(
                                          'externalLinkTarget'),
                            ...
                            this.pdfViewer = new _pdf_viewer.PDFViewer({
                              ...
                              renderer :
                                  _app_options.AppOptions.get('renderer'),
                              enableWebGL :
                            ...
                            this.findBar = new _pdf_find_bar.PDFFindBar(
                                appConfig.findBar, eventBus, this.l10n);
                            ...
                            this.toolbar = new _toolbar.Toolbar(
                                appConfig.toolbar, eventBus, this.l10n);
                            this.secondaryToolbar =
                                new _secondary_toolbar.SecondaryToolbar(
                                    appConfig.secondaryToolbar, container,
                                    eventBus);
          ...
          run : function run(
              config) { this.initialize(config).then(webViewerInitialized); },
          ...
          set page(val) { this.pdfViewer.currentPageNumber = val; },

          get page() { return this.pdfViewer.currentPageNumber; },

          get printing() { return !!this.printService; },
          ...
          get supportsFullscreen() {
            ...
            support =
                !!(doc.requestFullscreen || doc.mozRequestFullScreen ||
          ...
          close : function() {
            var _close = _asyncToGenerator(
                ...
                _regenerator.default.mark(function _callee6() {
                  ...
                  return _regenerator.default
                      .wrap(function _callee6$(_context6) {
                        while (1) {
                          switch (_context6.prev = _context6.next) {
                          case 0:
                            errorWrapper =
                                this.appConfig.errorWrapper.container;
            ...
            function close() { return _close.apply(this, arguments); }
          ...
          open : function() {
            var _open = _asyncToGenerator(
                ...
                _regenerator.default.mark(function _callee7(file, args) {
                  ...
                  var workerParameters, key, parameters, apiParameters, _key,
                      prop, loadingTask;
                  ...
                  return _regenerator.default.wrap(function _callee7$(_context7) {
                    while (1) {
                      ...
                      case 3:
                        ...
                        loadingTask.onPassword = function(updateCallback,
                                                          reason) {
                        ...
                        return _context7.abrupt(
                            ...
                            loadingTask.promise.then(
                                function(
                                    pdfDocument) { _this2.load(pdfDocument); },
                                function(exception) {
                                  ...
                                  return loadingErrorMessage.then(function(
                                      msg) {
            ...
            function open(_x2, _x3) { return _open.apply(this, arguments); }
          ...
          download : function download() {
            ...
            var filename = this.contentDispositionFilename ||
                           (0, _ui_utils.getPDFFileNameFromURL)(this.url);
            var downloadManager = this.downloadManager;

            downloadManager.onerror = function(
                err) { _this3.error("PDF failed to download: ".concat(err)); };
          ...
          error : function error(message, moreInfo) {
            ...
            closeButton.onclick =
                function() { errorWrapper.setAttribute('hidden', 'true'); };
          ...
          load : function load(pdfDocument) {
            ...
            var pageModePromise =
                pdfDocument.getPageMode().catch(function() {});
            var openActionDestPromise =
                pdfDocument.getOpenActionDestination().catch(function() {});
            ...
            firstPagePromise.then(function(pdfPage) {
              ...
              var storePromise =
                  store
                      ...
                      .catch(function() {});
              Promise
                  .all([ storePromise, pageModePromise, openActionDestPromise ])
                  .then(
                      /*#__PURE__*/
                      function() {
                        var _ref3 = _asyncToGenerator(
                            ...
                            _regenerator.default.mark(function _callee8(_ref2) {
                              var _ref4, _ref4$, values, pageMode,
                                  openActionDest, viewOnLoad, initialBookmark,
                                  zoom, hash, rotation, sidebarView, scrollMode,
                                  spreadMode;

                              return _regenerator.default
                                  .wrap(function _callee8$(_context8) {
                                    while (1) {
                                      ...
                                      case 0:
                                        ...
                                        if (values.page &&
                                          ...
                                          rotation =
                                              parseInt(values.rotation, 10);

                                          if (sidebarView ===
                                              _pdf_sidebar.SidebarView
                                                  .UNKNOWN) {
                                            sidebarView =
                  ...
                  .catch(function() { _this5.setInitialView(); })
            ...
            pdfDocument.getPageLabels().then(function(labels) {
              ...
              _this5.toolbar.setPageNumber(pdfViewer.currentPageNumber,
            ...
            Promise.all([ onePageRendered, _ui_utils.animationStarted ])
                .then(function() {
            ...
            pdfDocument.getMetadata().then(function(_ref5) {
              var info = _ref5.info, metadata = _ref5.metadata,
          ...
          _initializePdfHistory : function _initializePdfHistory(_ref6) {
            var fingerprint = _ref6.fingerprint, viewOnLoad = _ref6.viewOnLoad,
            ...
            if (initialDest && !this.initialBookmark &&
              ...
              this.pdfHistory.push(
                  {explicitDest : initialDest, pageNumber : null});
            }
          },
          setInitialView : function setInitialView(storedHash) {
            ...
            var _ref7 = arguments.length > 1 && arguments[1] !== undefined
                            ? arguments[1]
                            : {},
                rotation = _ref7.rotation, sidebarView = _ref7.sidebarView,
                scrollMode = _ref7.scrollMode, spreadMode = _ref7.spreadMode;
          ...
          beforePrint : function beforePrint() {
            ...
            if (!this.supportsPrinting) {
              this.l10n
                  .get('printing_not_supported', null,
                       'Warning: Printing is not fully supported by ' +
                           'this browser.')
                  .then(function(printMessage) { _this7.error(printMessage); });
              return;
            }

            if (!this.pdfViewer.pageViewsReady) {
              this.l10n
                  .get('printing_not_ready', null,
                       'Warning: The PDF is not fully loaded for printing.')
                  .then(function(
                      notReadyMessage) { window.alert(notReadyMessage); });
              return;
            }
          ...
          bindWindowEvents : function bindWindowEvents() {
            ...
            _boundEvents.windowResize =
                function() { eventBus.dispatch('resize', {source : window}); };
          ...
          unbindEvents : function unbindEvents() {
            ...
            eventBus.off('presentationmodechanged',
                         webViewerPresentationModeChanged);
          ...
          validateFileURL = function validateFileURL(file) {
            ...
            try {
              ...
              var _ref8 = new _pdfjsLib.URL(file, window.location.href),
                  origin = _ref8.origin, protocol = _ref8.protocol;
        ...
        function loadAndEnablePDFBug(enabledTabs) {
          ...
          return (0, _pdfjsLib.loadScript)(appConfig.debuggerScriptPath)
              .then(function() {
        ...
        function webViewerInitialized() {
          ...
          if (!window.File || !window.FileReader || !window.FileList ||
            ...
            appConfig.secondaryToolbar.openFileButton.setAttribute('hidden',
                                                                   'true');
          } else {
          ...
          fileInput.addEventListener('change', function(evt) {
            ...
            PDFViewerApplication.eventBus.dispatch(
                'fileinputchange', {source : this, fileInput : evt.target});
          });
          ...
          appConfig.mainContainer.addEventListener('drop', function(evt) {
            ...
            PDFViewerApplication.eventBus.dispatch(
                'fileinputchange',
                {source : this, fileInput : evt.dataTransfer});
          });
          ...
          try {
            ...
            PDFViewerApplication.l10n
                .get('loading_error', null,
                     'An error occurred while loading the PDF.')
                .then(function(
                    msg) { PDFViewerApplication.error(msg, reason); });
          }
        }
        ...
        function webViewerPageRendered(evt) {
          ...
          if (pageView.error) {
            PDFViewerApplication.l10n
                .get('rendering_error', null,
                     'An error occurred while rendering the page.')
                .then(function(
                    msg) { PDFViewerApplication.error(msg, pageView.error); });
          }
        }
        ...
        function webViewerPresentationModeChanged(evt) {
          ...
          PDFViewerApplication.pdfViewer.presentationModeState =
              switchInProgress
                  ...
                  : active ? _ui_utils.PresentationModeState.FULLSCREEN
        ...
        function webViewerUpdateViewarea(evt) {
          ...
          PDFViewerApplication.appConfig.secondaryToolbar.viewBookmarkButton
              .href = href;
          var currentPage = PDFViewerApplication.pdfViewer.getPageView(
              PDFViewerApplication.page - 1);
          var loading = currentPage.renderingState !==
        ...
        var webViewerFileInputChange;
        {
          webViewerFileInputChange = function webViewerFileInputChange(evt) {
            ...
            appConfig.secondaryToolbar.downloadButton.setAttribute('hidden',
                                                                   'true');
          };
        }
        ...
        function webViewerUpdateFindControlState(_ref10) {
          var state = _ref10.state, previous = _ref10.previous,
          ...
          if (PDFViewerApplication.supportsIntegratedFind) {
            ...
            PDFViewerApplication.findBar.updateUIState(state, previous,
                                                       matchesCount);
          }
        }
        ...
        function setZoomDisabledTimeout() {
          ...
          zoomDisabledTimeout =
              setTimeout(function() { zoomDisabledTimeout = null; },
        ...
        /* WEBPACK VAR INJECTION */ (function(module) {
          ...
          !function(global) {
            ...
            runtime = global.regeneratorRuntime =
                inModule ? module.exports : {};

            function wrap(innerFn, outerFn, self, tryLocsList) {
              var protoGenerator =
                  outerFn && outerFn.prototype instanceof Generator ? outerFn
                                                                    : Generator;
            ...
            function defineIteratorMethods(prototype) {
              ["next", "throw", "return"].forEach(function(method) {
                prototype[method] = function(
                    arg) { return this._invoke(method, arg); };
              });
            }
            ...
            runtime.async = function(innerFn, outerFn, self, tryLocsList) {
              var iter =
                  new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList));
              ...
              return function invoke(method, arg) {
                ...
                while (true) {
                  ...
                  if (record.type === "normal") {
                    state = context.done ? GenStateCompleted
            ...
            Context.prototype = {
              ...
              delegateYield : function delegateYield(iterable, resultName,
                                                     nextLoc) {
                this.delegate = {
            ...
            return this ||
                   (typeof self === "undefined" ? "undefined"
                                                : _typeof(self)) === "object" &&
                       self;
          }() ||
            Function("return this")());
        ...
        module.exports = function(module) {
          if (!module.webpackPolyfill) {
            ...
            Object.defineProperty(
                module, "loaded",
                {enumerable : true, get : function get() { return module.l; }});
            Object.defineProperty(
                module, "id",
                {enumerable : true, get : function get() { return module.i; }});
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        exports.WaitOnType = exports.animationStarted = exports.ProgressBar =
            exports.EventBus = exports.NullL10n = exports.SpreadMode =
                exports.ScrollMode = exports.TextLayerMode =
                    exports.RendererType = exports.PresentationModeState =
                        exports.VERTICAL_PADDING = exports.SCROLLBAR_PADDING =
                            exports.MAX_AUTO_SCALE = exports.UNKNOWN_SCALE =
                                exports.MAX_SCALE = exports.MIN_SCALE =
        ...
        var RendererType = {CANVAS : 'canvas', SVG : 'svg'};
        exports.RendererType = RendererType;
        var TextLayerMode = {DISABLE : 0, ENABLE : 1, ENABLE_ENHANCE : 2};
        exports.TextLayerMode = TextLayerMode;
        var ScrollMode =
            {UNKNOWN : -1, VERTICAL : 0, HORIZONTAL : 1, WRAPPED : 2};
        exports.ScrollMode = ScrollMode;
        var SpreadMode = {UNKNOWN : -1, NONE : 0, ODD : 1, EVEN : 2};
        ...
        function getPageSizeInches(_ref) {
          ...
          var _view = _slicedToArray(view, 4), x1 = _view[0], y1 = _view[1],
              x2 = _view[2], y2 = _view[3];
        ...
        function getVisibleElements(scrollEl, views) {
          var sortByVisibility =
              arguments.length > 2 && arguments[2] !== undefined ? arguments[2]
                                                                 : false;
          var horizontal = arguments.length > 3 && arguments[3] !== undefined
                               ? arguments[3]
                               : false;
          ...
          var firstVisibleElementInd =
              numViews === 0
                  ...
                  : binarySearchFirstItem(
                        views, horizontal ? isElementRightAfterViewLeft
          ...
          for (var i = firstVisibleElementInd; i < numViews; i++) {
            ...
            var percent = (viewHeight - hiddenHeight) *
                              (viewWidth - hiddenWidth) * 100 / viewHeight /
                              viewWidth |
                          0;
            visible.push({
              id : view.id,
        ...
        function normalizeWheelEventDelta(evt) {
          var delta =
              Math.sqrt(evt.deltaX * evt.deltaX + evt.deltaY * evt.deltaY);
        ...
        var WaitOnType = {EVENT : 'event', TIMEOUT : 'timeout'};
        exports.WaitOnType = WaitOnType;

        function waitOnEventOrTimeout(_ref2) {
          var target = _ref2.target, name = _ref2.name,
        ...
        var animationStarted = new Promise(function(
            ...
            function() {
              function EventBus() {
                var _ref3 = arguments.length > 0 && arguments[0] !== undefined
                    ...
                    dispatchToDOM = _ref3$dispatchToDOM === void 0
                                        ? false
                                        : _ref3$dispatchToDOM;
        ...
        function getGlobalEventBus() {
          var dispatchToDOM = arguments.length > 0 && arguments[0] !== undefined
                                  ? arguments[0]
                                  : false;
            ...
            function() {
              function ProgressBar(id) {
                var _ref4 = arguments.length > 1 && arguments[1] !== undefined
                                ? arguments[1]
                                : {},
                    height = _ref4.height, width = _ref4.width,
                    units = _ref4.units;
              ...
              _createClass(ProgressBar, [
                ...
                {
                  key : "percent",
                  get : function get() { return this._percent; },
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        var CursorTool = {SELECT : 0, HAND : 1, ZOOM : 2};
        ...
        var PDFCursorTools =
            ...
            function() {
              function PDFCursorTools(_ref) {
                ...
                var container = _ref.container, eventBus = _ref.eventBus,
                    _ref$cursorToolOnLoad = _ref.cursorToolOnLoad,
                    cursorToolOnLoad = _ref$cursorToolOnLoad === void 0
                                           ? CursorTool.SELECT
                ...
                this.handTool =
                    new _grab_to_pan.GrabToPan({element : this.container});

                this._addEventListeners();

                Promise.resolve().then(
                    function() { _this.switchTool(cursorToolOnLoad); });
              }
              ...
              _createClass(PDFCursorTools, [
                {
                  ...
                  value : function switchTool(tool) {
                    ...
                    case CursorTool.ZOOM:
                    default:
                      console.error("switchTool: \"".concat(
                          tool, "\" is an unsupported value."));
                      return;
                    }
                ...
                },
                {
                  ...
                  value : function _addEventListeners() {
                    ...
                    this.eventBus.on(
                        'switchcursortool',
                        function(evt) { _this3.switchTool(evt.tool); });
                ...
                {
                  key : "activeTool",
                  get : function get() { return this.active; }
                }
              ]);
              ...
              _createClass(PDFRenderingQueue, [
                ...
                },
                {
                  ...
                  value : function renderHighestPriority(
                    ...
                    if (this.onIdle) {
                      this.idleTimeout =
                          setTimeout(this.onIdle.bind(this), CLEANUP_TIMEOUT);
                    }
                  }
                },
                {
                  key : "getHighestPriority",
                  value : function getHighestPriority(visible, views,
                                                      scrolledDown) {
                ...
                },
                {
                  ...
                  value : function renderView(view) {
                    ...
                    case RenderingStates.INITIAL:
                      ...
                      continueRendering() { _this.renderHighestPriority(); };
        ...
        var PDFSidebar =
            ...
            function() {
              function PDFSidebar(options, eventBus) {
                var l10n = arguments.length > 2 && arguments[2] !== undefined
                               ? arguments[2]
                               : _ui_utils.NullL10n;
              ...
              _createClass(PDFSidebar, [
                ...
                },
                {
                  ...
                  value : function _switchView(view) {
                    ...
                    default:
                      console.error("PDFSidebar._switchView: \"".concat(
                    ...
                    this.thumbnailButton.classList.toggle(
                        'toggled', view === SidebarView.THUMBS);
                    this.outlineButton.classList.toggle(
                        'toggled', view === SidebarView.OUTLINE);
                    this.attachmentsButton.classList.toggle(
                        'toggled', view === SidebarView.ATTACHMENTS);
                    this.thumbnailView.classList.toggle(
                        'hidden', view !== SidebarView.THUMBS);
                    this.outlineView.classList.toggle(
                        'hidden', view !== SidebarView.OUTLINE);
                    this.attachmentsView.classList.toggle(
                        'hidden', view !== SidebarView.ATTACHMENTS);
                ...
                },
                {
                  ...
                  value : function _dispatchEvent() {
                    this.eventBus.dispatch(
                        'sidebarviewchanged',
                        {source : this, view : this.visibleView});
                  }
                },
                {
                  key : "_forceRendering",
                ...
                },
                {
                  ...
                  value : function _updateThumbnailViewer() {
                    ...
                    for (var pageIndex = 0; pageIndex < pagesCount;
                         pageIndex++) {
                ...
                },
                {
                  ...
                  value : function _showUINotification(view) {
                    ...
                    this.l10n
                        .get(
                            'toggle_sidebar_notification.title', null,
                            'Toggle Sidebar (document contains outline/attachments)')
                        .then(function(
                            msg) { _this.toggleButton.title = msg; });
                ...
                },
                {
                  ...
                  value : function _hideUINotification(view) {
                    ...
                    this.l10n
                        ...
                        .then(function(
                            msg) { _this2.toggleButton.title = msg; });
                  }
                },
                {
                  key : "_addEventListeners",
                  value : function _addEventListeners() {
                    ...
                    this.thumbnailButton.addEventListener(
                        'click',
                        function() { _this3.switchView(SidebarView.THUMBS); });
                    this.outlineButton.addEventListener(
                        'click',
                        function() { _this3.switchView(SidebarView.OUTLINE); });
                    ...
                    this.eventBus.on('presentationmodechanged', function(evt) {
                      if (!evt.active && !evt.switchInProgress &&
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        var OptionKind = {VIEWER : 'viewer', API : 'api', WORKER : 'worker'};
        exports.OptionKind = OptionKind;
        var defaultOptions = {
          cursorToolOnLoad : {value : 0, kind : OptionKind.VIEWER},
          defaultUrl : {
            value : 'compressed.tracemonkey-pldi-09.pdf',
            kind : OptionKind.VIEWER
          },
          defaultZoomValue : {value : '', kind : OptionKind.VIEWER},
          disableHistory : {value : false, kind : OptionKind.VIEWER},
          disablePageLabels : {value : false, kind : OptionKind.VIEWER},
          enablePrintAutoRotate : {value : false, kind : OptionKind.VIEWER},
          enableWebGL : {value : false, kind : OptionKind.VIEWER},
          eventBusDispatchToDOM : {value : false, kind : OptionKind.VIEWER},
          externalLinkRel : {
            value : 'noopener noreferrer nofollow',
            kind : OptionKind.VIEWER
          },
          externalLinkTarget : {value : 0, kind : OptionKind.VIEWER},
          historyUpdateUrl : {value : false, kind : OptionKind.VIEWER},
          ...
          pdfBugEnabled : {value : false, kind : OptionKind.VIEWER},
          renderer : {value : 'canvas', kind : OptionKind.VIEWER},
          renderInteractiveForms : {value : false, kind : OptionKind.VIEWER},
          sidebarViewOnLoad : {value : -1, kind : OptionKind.VIEWER},
          scrollModeOnLoad : {value : -1, kind : OptionKind.VIEWER},
          spreadModeOnLoad : {value : -1, kind : OptionKind.VIEWER},
          textLayerMode : {value : 1, kind : OptionKind.VIEWER},
          useOnlyCssZoom : {value : false, kind : OptionKind.VIEWER},
          viewOnLoad : {value : 0, kind : OptionKind.VIEWER},
          cMapPacked : {value : true, kind : OptionKind.API},
          cMapUrl : {value : '../web/cmaps/', kind : OptionKind.API},
          disableAutoFetch : {value : false, kind : OptionKind.API},
          disableCreateObjectURL : {
            value : false,
            compatibility :
          ...
          disableFontFace : {value : false, kind : OptionKind.API},
          disableRange : {value : false, kind : OptionKind.API},
          disableStream : {value : false, kind : OptionKind.API},
          ...
          postMessageTransfers : {value : true, kind : OptionKind.API},
          verbosity : {value : 1, kind : OptionKind.API},
          workerPort : {value : null, kind : OptionKind.WORKER},
          workerSrc :
              {value : '../build/pdf.worker.js', kind : OptionKind.WORKER}
        };
        {
              ...
              _createClass(AppOptions, null, [
                ...
                },
                {
                  ...
                  value : function set(name,
                                       value) { userOptions[name] = value; }
                },
                {
                  key : "remove",
                  value : function remove(name) { delete userOptions[name]; }
                }
              ]);
                  ...
                  value : function() {
                    var _register = _asyncToGenerator(
                        ...
                        _regenerator.default.mark(function _callee(name,
                                                                   element) {
                          var callerCloseMethod, canForceClose, container,
                              _args = arguments;
                          return _regenerator.default
              ...
              _createClass(PasswordPrompt, [
                {
                  ...
                  value : function open() {
                    ...
                    this.overlayManager.open(this.overlayName).then(function() {
                      ...
                      promptString.then(function(
                          msg) { _this2.label.textContent = msg; });
                    });
                  }
                },
                {
                  ...
                  value : function close() {
                    ...
                    this.overlayManager.close(this.overlayName)
                        .then(function() { _this3.input.value = ''; });
                  }
                },
                {
                  key : "verify",
              ...
              _createClass(PDFAttachmentViewer, [
                ...
                },
                {
                  ...
                  value : function _dispatchEvent(attachmentsCount) {
                    ...
                    this.eventBus.dispatch(
                        'attachmentsloaded',
                        {source : this, attachmentsCount : attachmentsCount});
                  }
                },
                {
                  key : "_bindPdfLink",
                ...
                },
                {
                  ...
                  value : function _appendAttachment(_ref3) {
                    ...
                    var id = _ref3.id, filename = _ref3.filename,
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        var US_PAGE_NAMES = {'8.5x11' : 'Letter', '8.5x14' : 'Legal'};
        var METRIC_PAGE_NAMES = {'297x420' : 'A3', '210x297' : 'A4'};
        ...
        var PDFDocumentProperties =
            ...
            function() {
              function PDFDocumentProperties(_ref, overlayManager, eventBus) {
                ...
                var overlayName = _ref.overlayName, fields = _ref.fields,
                    container = _ref.container, closeButton = _ref.closeButton;
                var l10n = arguments.length > 3 && arguments[3] !== undefined
                               ? arguments[3]
                               : _ui_utils.NullL10n;
                ...
                if (eventBus) {
                  eventBus.on(
                      'pagechanging',
                      function(
                          evt) { _this._currentPageNumber = evt.pageNumber; });
                  eventBus.on(
                      'rotationchanging',
                      function(
                          evt) { _this._pagesRotation = evt.pagesRotation; });
                }

                this._isNonMetricLocale = true;
                l10n.getLanguage().then(function(locale) {
                  _this._isNonMetricLocale =
              ...
              _createClass(PDFDocumentProperties, [
                          ...
                          _this2.pdfDocument.getMetadata()
                              .then(function(_ref2) {
                                ...
                                return Promise.all([
                                  ...
                                  _this2.pdfDocument.getPage(currentPageNumber)
                                      .then(function(pdfPage) {
                                        return _this2._parsePageSize(
                                            (0, _ui_utils.getPageSizeInches)(
                                                pdfPage),
                                            pagesRotation);
                                      }),
                              ...
                              .then(function(_ref3) {
                                var _ref4 = _slicedToArray(_ref3, 8),
                                    info = _ref4[0], metadata = _ref4[1],
                                    fileName = _ref4[2], fileSize = _ref4[3],
                                    creationDate = _ref4[4], modDate = _ref4[5],
                                    pageSize = _ref4[6],
                ...
                },
                {
                  ...
                  value : function _parsePageSize(pageSizeInches,
                    ...
                    var isPortrait =
                        (0, _ui_utils.isPortraitOrientation)(pageSizeInches);
                    var sizeInches = {
                    ...
                    var name =
                        ...
                        getPageName(sizeMillimeters, isPortrait,
                                    METRIC_PAGE_NAMES);
                    ...
                    if (!name && !(Number.isInteger(sizeMillimeters.width) &&
                      ...
                      if (Math.abs(exactMillimeters.width -
                                   intMillimeters.width) < 0.1 &&
                          Math.abs(exactMillimeters.height -
                                   intMillimeters.height) < 0.1) {
                        name = getPageName(intMillimeters, isPortrait,
                                           METRIC_PAGE_NAMES);
                    ...
                    return Promise
                        .all([
                          this._isNonMetricLocale ? sizeInches
                                                  : sizeMillimeters,
                          this.l10n.get(
                              'document_properties_page_size_unit_' +
                                  (this._isNonMetricLocale ? 'inches'
                                                           : 'millimeters'),
                              null, this._isNonMetricLocale ? 'in' : 'mm'),
                          pageName,
                          this.l10n.get(
                              'document_properties_page_size_orientation_' +
                                  (isPortrait ? 'portrait' : 'landscape'),
                              null, isPortrait ? 'portrait' : 'landscape')
                        ])
                        .then(function(_ref6) {
                          var _ref7 = _slicedToArray(_ref6, 4),
                              _ref7$ = _ref7[0], width = _ref7$.width,
                              height = _ref7$.height, unit = _ref7[1],
                              name = _ref7[2], orientation = _ref7[3];
                ...
                },
                {
                  ...
                  value : function _parseDate(inputDate) {
                    ...
                    var offsetHours =
                        parseInt(dateToParse.substring(15, 17), 10);
                    var offsetMinutes =
                        parseInt(dateToParse.substring(18, 20), 10);
            ...
            function() {
              function PDFFindBar(options) {
                ...
                this.toggleButton.addEventListener(
                    'click', function() { _this.toggle(); });
                this.findField.addEventListener(
                    'input', function() { _this.dispatchEvent(''); });
                ...
                this.findPreviousButton.addEventListener(
                    'click',
                    function() { _this.dispatchEvent('again', true); });
                this.findNextButton.addEventListener(
                    'click',
                    function() { _this.dispatchEvent('again', false); });
                this.highlightAll.addEventListener(
                    'click',
                    function() { _this.dispatchEvent('highlightallchange'); });
                this.caseSensitive.addEventListener('click', function() {
                  _this.dispatchEvent('casesensitivitychange');
                });
                this.entireWord.addEventListener(
                    'click',
                    function() { _this.dispatchEvent('entirewordchange'); });
              ...
              _createClass(PDFFindBar, [
                {
                  key : "reset",
                  value : function reset() { this.updateUIState(); }
                },
                {
                  key : "dispatchEvent",
                    ...
                    case _pdf_find_controller.FindState.WRAPPED:
                      if (previous) {
                        findMsg = this.l10n.get(
                            'find_reached_top', null,
                            'Reached top of document, continued from bottom');
                      } else {
                        findMsg = this.l10n.get(
                            'find_reached_bottom', null,
                ...
                },
                {
                  ...
                  value : function updateResultsCount() {
                    ...
                    if (total > 0) {
                      if (total > limit) {
                        matchesCountMsg = this.l10n.get(
                            'find_match_count_limit', {limit : limit},
                            'More than {{limit}} match' +
                                (limit !== 1 ? 'es' : ''));
                      } else {
                        matchesCountMsg =
                            this.l10n.get('find_match_count',
                    ...
                    Promise.resolve(matchesCountMsg).then(function(msg) {
                      ...
                      _this3.findResultsCount.classList.toggle('hidden',
                                                               !total);
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        var FindState = {FOUND : 0, NOT_FOUND : 1, WRAPPED : 2, PENDING : 3};
        ...
        function normalize(text) {
          ...
          return text.replace(
              normalizationRegex,
              function(ch) { return CHARACTERS_TO_NORMALIZE[ch]; });
        }
        ...
        var PDFFindController =
            ...
            function() {
              ...
              _createClass(PDFFindController, [
                ...
                },
                {
                  ...
                  value : function scrollMatchIntoView(_ref2) {
                    var _ref2$element = _ref2.element,
                        element =
                            _ref2$element === void 0 ? null : _ref2$element,
                ...
                {
                  key : "_prepareMatches",
                  value : function _prepareMatches(matchesWithLength, matches,
                                                   matchesLength) {
                    ...
                    for (var i = 0, len = matchesWithLength.length; i < len;
                         i++) {
                ...
                },
                {
                  ...
                  value : function _isEntireWord(content, startIdx, length) {
                    if (startIdx > 0) {
                      ...
                      if ((0, _pdf_find_utils.getCharacterType)(first) ===
                    ...
                    if (endIdx < content.length - 1) {
                      ...
                      if ((0, _pdf_find_utils.getCharacterType)(last) ===
                ...
                },
                {
                  ...
                  value : function _calculatePhraseMatch(
                      query, pageIndex, pageContent, entireWord) {
                    var matches = [];
                    ...
                    while (true) {
                      matchIdx =
                          pageContent.indexOf(query, matchIdx + queryLen);

                      if (matchIdx === -1) {
                        break;
                      }

                      if (entireWord && !this._isEntireWord(
                                            pageContent, matchIdx, queryLen)) {
                        continue;
                      }
                ...
                },
                {
                  ...
                  value : function _calculateWordMatch(
                    ...
                    for (var i = 0, len = queryArray.length; i < len; i++) {
                      ...
                      while (true) {
                        matchIdx = pageContent.indexOf(subquery,
                        ...
                        if (entireWord &&
                            !this._isEntireWord(pageContent, matchIdx,
                                                subqueryLen)) {
                          continue;
                        }
                    ...
                    this._prepareMatches(matchesWithLength,
                                         this._pageMatches[pageIndex],
                                         this._pageMatchesLength[pageIndex]);
                  }
                },
                ...
                },
                {
                  ...
                  value : function _extractText() {
                        ...
                        return _this2._pdfDocument.getPage(i + 1)
                            ...
                            .then(
                                function(textContent) {
                                  ...
                                  for (var j = 0, jj = textItems.length; j < jj;
                                       j++) {
                    ...
                    for (var i = 0, ii = this._linkService.pagesCount; i < ii;
                         i++) {
                      _loop(i, ii);
                    }
                  }
                ...
                },
                {
                  ...
                  value : function _advanceOffsetPage(previous) {
                    ...
                    var numPages = this._linkService.pagesCount;
                    offset.pageIdx =
                        previous ? offset.pageIdx - 1 : offset.pageIdx + 1;
                    offset.matchIdx = null;
                    this._pagesToSearch--;
                ...
                },
                {
                  ...
                  get : function get() { return this._highlightMatches; }
                },
                {
                  key : "pageMatches",
                  get : function get() { return this._pageMatches; }
                },
                {
                  key : "pageMatchesLength",
                  get : function get() { return this._pageMatchesLength; }
                },
                {
                  key : "selected",
                  get : function get() { return this._selected; }
                },
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        function getCurrentHash() { return document.location.hash; }
        ...
        var PDFHistory =
            ...
            function() {
              function PDFHistory(_ref) {
                ...
                this.eventBus.on(
                    'pagesloaded',
                    function(evt) { _this._isPagesLoaded = !!evt.pagesCount; });
              }
              ...
              _createClass(PDFHistory, [
                {
                  ...
                  value : function initialize(_ref2) {
                    var fingerprint = _ref2.fingerprint,
                        ...
                        resetHistory = _ref2$resetHistory === void 0
                                           ? false
                                           : _ref2$resetHistory,
                        _ref2$updateUrl = _ref2.updateUrl,
                        updateUrl = _ref2$updateUrl === void 0
                                        ? false
                                        : _ref2$updateUrl;
                  ...
                  value : function push(_ref3) {
                    ...
                    if (this._destination &&
                        (isDestHashesEqual(this._destination.hash, hash) ||
                         isDestArraysEqual(this._destination.dest,
                                           explicitDest))) {
                    ...
                    if (!this._popStateInProgress) {
                      ...
                      Promise.resolve().then(
                          function() { _this2._popStateInProgress = false; });
                    }
                  }
                },
                {
                  ...
                  value : function _pushOrReplaceState(destination) {
                    ...
                    if (this._updateUrl && destination && destination.hash) {
                      ...
                      if (!baseUrl.startsWith('file://')) {
                        newUrl =
                            "".concat(baseUrl, "#").concat(destination.hash);
                      }
                    }
                ...
                },
                {
                  ...
                  value : function _tryPushCurrentPosition() {
                    ...
                    if (temporary) {
                      position =
                          Object.assign(Object.create(null), this._position);
                    ...
                    if (state.fingerprint !== this.fingerprint) {
                      if (checkReload) {
                        ...
                        var _performance$getEntri =
                            ...
                            _performance$getEntri2 =
                                _slicedToArray(_performance$getEntri, 1),
                ...
                },
                {
                  ...
                  value : function _popState(_ref5) {
                    ...
                    if (hashChanged) {
                      ...
                      }).then(function() { _this4._blockHashChange--; });
                    }
                    ...
                    Promise.resolve().then(
                        function() { _this4._popStateInProgress = false; });
                  }
                },
                {
                  key : "_bindEvents",
                  value : function _bindEvents() {
                    ...
                    _boundEvents.updateViewarea =
                        this._updateViewarea.bind(this);
        ...
        function isDestArraysEqual(firstDest, secondDest) {
          function isEntryEqual(first, second) {
            ...
            if (first !== null && _typeof(first) === 'object' &&
                second !== null) {
      ...
      /***/ (function(module, exports, __webpack_require__) {
            ...
            function() {
              function PDFLinkService() {
                var _ref = arguments.length > 0 && arguments[0] !== undefined
                    ...
                    externalLinkTarget = _ref$externalLinkTarg === void 0
                                             ? null
                                             : _ref$externalLinkTarg,
                    _ref$externalLinkRel = _ref.externalLinkRel,
                    externalLinkRel = _ref$externalLinkRel === void 0
                                          ? null
              ...
              _createClass(PDFLinkService, [
                ...
                },
                {
                  ...
                  value : function setHistory(
                      pdfHistory) { this.pdfHistory = pdfHistory; }
                },
                {
                  key : "navigateTo",
                  value : function navigateTo(dest) {
                    ...
                    var goToDestination = function goToDestination(_ref2) {
                      ...
                      if (destRef instanceof Object) {
                        ...
                        if (pageNumber === null) {
                          _this.pdfDocument.getPageIndex(destRef)
                      ...
                      _this.pdfViewer.scrollPageIntoView(
                          {pageNumber : pageNumber, destArray : explicitDest});
                    };
                    ...
                    new Promise(function(resolve, reject) {
                      if (typeof dest === 'string') {
                        _this.pdfDocument.getDestination(dest).then(function(
                            destArray) {
                          resolve({namedDest : dest, explicitDest : destArray});
                        });
                ...
                },
                {
                  ...
                  value : function getAnchorUrl(
                      anchor) { return (this.baseUrl || '') + anchor; }
                },
                {
                  key : "setHash",
                  value : function setHash(hash) {
                    ...
                    if (hash.includes('=')) {
                        ...
                        if (!zoomArg.includes('Fit')) {
                          ...
                          if (zoomArg === 'Fit' || zoomArg === 'FitB') {
                            ...
                            if (zoomArgs.length !== 5) {
                              ...
                              dest = [
                                null, {name : zoomArg}, zoomArgs[1] | 0,
                                zoomArgs[2] | 0, zoomArgs[3] | 0,
                                zoomArgs[4] | 0
                              ];
                            }
                          } else {
                      ...
                      if ('pagemode' in params) {
                        this.eventBus.dispatch(
                            'pagemode',
                            {source : this, mode : params.pagemode});
                      }
                    } else {
                      dest = unescape(hash);
                ...
                },
                {
                  ...
                  value : function _cachedPageNumber(pageRef) {
                    var refStr = pageRef.num + ' ' + pageRef.gen + ' R';
                    return this._pagesRefCache && this._pagesRefCache[refStr] ||
                           null;
                  }
                },
                {
                ...
                },
                {
                  key : "page",
                  get : function
                      get() { return this.pdfViewer.currentPageNumber; },
                  set : function set(
                      value) { this.pdfViewer.currentPageNumber = value; }
                },
                {
                  key : "rotation",
                  get : function get() { return this.pdfViewer.pagesRotation; },
                  set : function set(
                      value) { this.pdfViewer.pagesRotation = value; }
                }
              ]);
        ...
        function isValidExplicitDestination(dest) {
          ...
          if (!(_typeof(page) === 'object' && Number.isInteger(page.num) &&
            ...
            function() {
              ...
              _createClass(SimpleLinkService, [
                {key : "navigateTo", value : function navigateTo(dest) {}}, {
                  key : "getDestinationHash",
                  value : function getDestinationHash(dest) { return '#'; }
                },
                {
                  key : "getAnchorUrl",
                  value : function getAnchorUrl(hash) { return '#'; }
                },
                ...
                {
                  key : "isPageVisible",
                  value : function isPageVisible(pageNumber) { return true; }
                },
        ...
        var PDFOutlineViewer =
            ...
            function() {
              function PDFOutlineViewer(_ref) {
                var container = _ref.container, linkService = _ref.linkService,
                    eventBus = _ref.eventBus;
              ...
              _createClass(PDFOutlineViewer, [
                ...
                },
                {
                  ...
                  value : function _dispatchEvent(outlineCount) {
                    this.eventBus.dispatch(
                        'outlineloaded',
                        {source : this, outlineCount : outlineCount});
                  }
                },
                {
                  key : "_bindLink",
                  value : function _bindLink(element, _ref2) {
                    var url = _ref2.url, newWindow = _ref2.newWindow,
                        dest = _ref2.dest;
                    ...
                    if (url) {
                      (0, _pdfjsLib.addLinkAttributes)(element, {
                        url : url,
                        target : newWindow ? _pdfjsLib.LinkTarget.BLANK
                ...
                },
                {
                  ...
                  value : function _toggleOutlineItem(root) {
                    ...
                    try {
                      for (var _iterator = root.querySelectorAll(
                                   '.outlineItemToggler')[Symbol.iterator](),
                               _step;
                ...
                },
                {
                  ...
                  value : function toggleOutlineTree() {
                    ...
                    this._toggleOutlineItem(this.container,
                ...
                },
                {
                  ...
                  value : function render(_ref4) {
                    ...
                    while (queue.length > 0) {
                      ...
                      for (var i = 0, len = levelData.items.length; i < len;
                           i++) {
        ...
        var PDFPresentationMode =
            ...
            function() {
              function PDFPresentationMode(_ref) {
                ...
                var container = _ref.container, _ref$viewer = _ref.viewer,
                    viewer = _ref$viewer === void 0 ? null : _ref$viewer,
                    pdfViewer = _ref.pdfViewer, eventBus = _ref.eventBus,
                    _ref$contextMenuItems = _ref.contextMenuItems,
                    contextMenuItems = _ref$contextMenuItems === void 0
                                           ? null
              ...
              _createClass(PDFPresentationMode, [
                ...
                },
                {
                  ...
                  value : function _mouseWheel(evt) {
                    ...
                    if (Math.abs(this.mouseScrollDelta) >=
                ...
                },
                {
                  ...
                  value : function _enter() {
                    ...
                    this.contextMenuOpen = false;
                    this.container.setAttribute('contextmenu',
                                                'viewerContextMenu');
                ...
                },
                {
                  key : "_contextMenu",
                  value :
                      function _contextMenu() { this.contextMenuOpen = true; }
                },
                {
                  key : "_showControls",
                ...
                },
                {
                  ...
                  value : function _touchSwipe(evt) {
                    ...
                    case 'touchend':
                      ...
                      var delta = 0;
                      var dx = this.touchSwipeState.endX -
                               this.touchSwipeState.startX;
                      var dy = this.touchSwipeState.endY -
        ...
        var PDFSidebarResizer =
            ...
            function() {
              function PDFSidebarResizer(options, eventBus) {
                ...
                this.l10n.getDirection().then(function(
                    dir) { _this.isRTL = dir === 'rtl'; });
                ...
                },
                {
                  ...
                  value : function _addEventListeners() {
                    ...
                    this.eventBus.on(
                        'sidebarviewchanged',
                        function(
                            evt) { _this2.sidebarOpen = !!(evt && evt.view); });
        ...
        var PDFThumbnailViewer =
            ...
            function() {
              function PDFThumbnailViewer(_ref) {
                var container = _ref.container, linkService = _ref.linkService,
                    renderingQueue = _ref.renderingQueue, _ref$l10n = _ref.l10n,
                    l10n =
                        _ref$l10n === void 0 ? _ui_utils.NullL10n : _ref$l10n;
                ...
                this.scroll = (0, _ui_utils.watchScroll)(
                    this.container, this._scrollUpdated.bind(this));
              ...
              _createClass(PDFThumbnailViewer, [
                ...
                },
                {
                  ...
                  value : function getThumbnail(
                      index) { return this._thumbnails[index]; }
                },
                {
                  key : "_getVisibleThumbs",
                  value : function _getVisibleThumbs() {
                    return (0, _ui_utils.getVisibleElements)(this.container,
                                                             this._thumbnails);
                  }
                },
                {
                    ...
                    if (numVisibleThumbs > 0) {
                      ...
                      if (shouldScroll) {
                        (0, _ui_utils.scrollIntoView)(
                            thumbnailView.div, {top : THUMBNAIL_SCROLL_MARGIN});
                      }
                    }
                  ...
                  value : function setDocument(pdfDocument) {
                    ...
                    pdfDocument.getPage(1)
                        .then(function(firstPage) {
                          ...
                          for (var pageNum = 1; pageNum <= pagesCount;
                               ++pageNum) {
                            var thumbnail =
                  ...
                  value : function _ensurePdfPageLoaded(thumbView) {
                    ...
                    var promise =
                        this.pdfDocument.getPage(pageNumber)
                            ...
                            .catch(function(reason) {
                              console.error('Unable to get page for thumb view',
                                            reason);
                              _this2._pagesRequests[pageNumber] = null;
                            });
                ...
                },
                {
                  ...
                  value : function forceRendering() {
                    ...
                    var thumbView = this.renderingQueue.getHighestPriority(
                        visibleThumbs, this._thumbnails, this.scroll.down);
                ...
                {
                  key : "pagesRotation",
                  get : function get() { return this._pagesRotation; },
            ...
            function() {
              function PDFThumbnailView(_ref) {
                ...
                this.l10n.get('thumb_page_title', {page : id}, 'Page {{page}}')
                    .then(function(msg) { anchor.title = msg; });
              ...
              _createClass(
                  ...
                  [
                    {
                      ...
                      value : function setPdfPage(pdfPage) {
                        ...
                        this.viewport = pdfPage.getViewport(
                            {scale : 1, rotation : totalRotation});
                        this.reset();
                      }
                    },
                    {
                    ...
                    },
                    {
                      ...
                      value : function _convertCanvasToImage() {
                        ...
                        if (this.disableCanvasToImageConversion) {
                          ...
                          this.l10n
                              .get('thumb_page_canvas', {page : this.pageId},
                    ...
                    },
                    {
                      ...
                      value : function draw() {
                        ...
                        var renderCapability =
                            (0, _pdfjsLib.createPromiseCapability)();

                        var finishRenderTask = function finishRenderTask(
                            error) {
                        ...
                        var drawViewport =
                            this.viewport.clone({scale : this.scale});

                        var renderContinueCallback =
                            function renderContinueCallback(cont) {
                          if (!_this2.renderingQueue.isHighestPriority(
                                  _this2)) {
                            _this2.renderingState =
                        ...
                        renderTask.promise.then(
                            function() { finishRenderTask(null); },
                            function(error) { finishRenderTask(error); });
                    ...
                    },
                    {
                      ...
                      value : function setImage(pageView) {
                        ...
                        var reducedWidth = canvas.width
                                           << MAX_NUM_SCALING_STEPS;
                        var reducedHeight = canvas.height
                                            << MAX_NUM_SCALING_STEPS;
                        var reducedImage = TempImageFactory.getCanvas(
                            reducedWidth, reducedHeight);
                        var reducedImageCtx = reducedImage.getContext('2d');

                        while (reducedWidth > img.width ||
                               reducedHeight > img.height) {
                          reducedWidth >>= 1;
                          reducedHeight >>= 1;
                        }

                        reducedImageCtx.drawImage(img, 0, 0, img.width,
                                                  img.height, 0, 0,
                                                  reducedWidth, reducedHeight);

                        while (reducedWidth > 2 * canvas.width) {
                          reducedImageCtx.drawImage(
                              reducedImage, 0, 0, reducedWidth, reducedHeight,
                              0, 0, reducedWidth >> 1, reducedHeight >> 1);
                          reducedWidth >>= 1;
                          reducedHeight >>= 1;
                        }

                        ctx.drawImage(reducedImage, 0, 0, reducedWidth,
                                      reducedHeight, 0, 0, canvas.width,
                                      canvas.height);
                    ...
                    },
                    {
                      ...
                      value : function setPageLabel(label) {
                        ...
                        this.l10n
                            .get('thumb_page_title', {page : this.pageId},
                                 'Page {{page}}')
                            .then(function(msg) { _this3.anchor.title = msg; });
                        ...
                        this.l10n
                            ...
                            .then(function(ariaLabel) {
                              if (_this3.image) {
                                _this3.image.setAttribute('aria-label',
                                                          ariaLabel);
                              } else if (_this3
                                             .disableCanvasToImageConversion &&
                                         _this3.canvas) {
                                _this3.canvas.setAttribute('aria-label',
                                                           ariaLabel);
                              }
                            });
                      }
                    },
                    {
                      key : "pageId",
                      get : function get() {
                        return this.pageLabel !== null ? this.pageLabel
                                                       : this.id;
                      }
                    }
                  ],
                  [ {
                    key : "cleanup",
                    value :
                        function cleanup() { TempImageFactory.destroyCanvas(); }
                  } ]);
          ...
          _getPrototypeOf =
              Object.setPrototypeOf
                  ...
                  : function _getPrototypeOf(
                        o) { return o.__proto__ || Object.getPrototypeOf(o); };
            ...
            function(_BaseViewer) {
              ...
              function PDFViewer() {
                ...
                return _possibleConstructorReturn(
                    this, _getPrototypeOf(PDFViewer).apply(this, arguments));
              }
              ...
              _createClass(PDFViewer, [
                {
                  ...
                  value : function _scrollIntoView(_ref) {
                    var pageDiv = _ref.pageDiv, _ref$pageSpot = _ref.pageSpot,
                        pageSpot =
                            _ref$pageSpot === void 0 ? null : _ref$pageSpot,
                    ...
                    if (!pageSpot && !this.isInPresentationMode) {
                      ...
                      if (this._isScrollModeHorizontal || left < scrollLeft ||
                          right > scrollLeft + clientWidth) {
                        pageSpot = {left : 0, top : 0};
                      }
                    }

                    _get(_getPrototypeOf(PDFViewer.prototype),
                ...
                },
                {
                  ...
                  value : function _getVisiblePages() {
                    ...
                    return _get(_getPrototypeOf(PDFViewer.prototype),
                                "_getVisiblePages", this)
                        .call(this);
                  }
                },
                {
                  ...
                  value : function _updateHelper(visiblePages) {
                    ...
                    try {
                      for (var _iterator = visiblePages[Symbol.iterator](),
                               _step;
                           !(_iteratorNormalCompletion =
                                 (_step = _iterator.next()).done);
                           _iteratorNormalCompletion = true) {
                ...
                },
                {
                  ...
                  get : function get() {
                    return (0, _pdfjsLib.shadow)(
                        this, '_setDocumentViewerElement', this.viewer);
                  }
                }
              ]);
        ...
        function PDFPageViewBuffer(size) {
          ...
          this.resize = function(newSize, pagesToKeep) {
            ...
            if (pagesToKeep) {
              ...
              (0, _ui_utils.moveToEndOfArray)(
                  data, function(page) { return pageIdsToKeep.has(page.id); });
            }
        ...
        var BaseViewer =
            ...
            function() {
              function BaseViewer(options) {
                ...
                this.scroll = (0, _ui_utils.watchScroll)(
                    this.container, this._scrollUpdate.bind(this));
              ...
              _createClass(BaseViewer, [
                {
                  ...
                  value : function getPageView(
                      index) { return this._pages[index]; }
                },
                {
                  ...
                  value : function setDocument(pdfDocument) {
                    ...
                    pagesCapability.promise.then(function() {
                      ...
                      _this2.eventBus.dispatch(
                          'pagesloaded',
                          {source : _this2, pagesCount : pagesCount});
                    });
                    var onePageRenderedCapability =
                        (0, _pdfjsLib.createPromiseCapability)();
                    ...
                    var bindOnAfterAndBeforeDraw =
                      ...
                      pageView.onBeforeDraw =
                          function() { _this2._buffer.push(pageView); };
                    ...
                    firstPagePromise
                        .then(function(pdfPage) {
                          ...
                          onePageRenderedCapability.promise.then(function() {
                            ...
                            for (var _pageNum = 1; _pageNum <= pagesCount;
                                 ++_pageNum) {
                              _loop(_pageNum);
                            }
                          });
                  ...
                  value : function _setScaleUpdatePages(newScale, newValue) {
                    ...
                    if (!noScroll) {
                      ...
                      if (this._location &&
                        ...
                        dest = [
                          null, {name : 'XYZ'}, this._location.left,
                ...
                },
                {
                  ...
                  value : function _setScale(value) {
                    ...
                    if (scale > 0) {
                      ...
                      var hPadding =
                          noPadding ? 0 : _ui_utils.SCROLLBAR_PADDING;
                      ...
                      case 'auto':
                        var horizontalScale =
                            (0, _ui_utils.isPortraitOrientation)(currentPage)
                                ? pageWidthScale
                                : Math.min(pageHeightScale, pageWidthScale);
                        scale =
                            Math.min(_ui_utils.MAX_AUTO_SCALE, horizontalScale);
                        break;
                ...
                },
                {
                  ...
                  value : function scrollPageIntoView(_ref3) {
                    var pageNumber = _ref3.pageNumber,
                        ...
                        allowNegativeOffset = _ref3$allowNegativeOf === void 0
                                                  ? false
                    ...
                    var pageView = Number.isInteger(pageNumber) &&
                    ...
                    case 'FitR':
                      ...
                      widthScale = (this.container.clientWidth - hPadding) /
                                   width / _ui_utils.CSS_UNITS;
                      heightScale = (this.container.clientHeight - vPadding) /
                                    height / _ui_utils.CSS_UNITS;
                      scale =
                          Math.min(Math.abs(widthScale), Math.abs(heightScale));
                      break;
                    ...
                    if (scale === 'page-fit' && !destArray[4]) {
                      this._scrollIntoView(
                          {pageDiv : pageView.div, pageNumber : pageNumber});
                    ...
                    var boundingRect = [
                      ...
                      pageView.viewport.convertToViewportPoint(x + width,
                                                               y + height)
                    ];
                ...
                },
                {
                  ...
                  value : function update() {
                    ...
                    var newCacheSize =
                        Math.max(DEFAULT_CACHE_SIZE, 2 * numVisiblePages + 1);
                    ...
                    this.eventBus.dispatch(
                        'updateviewarea',
                        {source : this, location : this._location});
                  }
                },
                {
                  key : "containsElement",
                  value : function containsElement(
                      element) { return this.container.contains(element); }
                },
                {
                  key : "focus",
                  value : function focus() { this.container.focus(); }
                },
                {
                ...
                },
                {
                  ...
                  value : function isPageVisible(pageNumber) {
                    ...
                    return this._getVisiblePages().views.some(function(
                        view) { return view.id === pageNumber; });
                  }
                },
                {
                  key : "cleanup",
                  ...
                  value : function _ensurePdfPageLoaded(pageView) {
                    ...
                    var promise =
                        this.pdfDocument.getPage(pageNumber)
                            ...
                            .catch(function(reason) {
                              console.error('Unable to get page for page view',
                                            reason);
                              _this3._pagesRequests[pageNumber] = null;
                            });
                    this._pagesRequests[pageNumber] = promise;
                ...
                },
                {
                  ...
                  value : function forceRendering(currentlyVisiblePages) {
                    ...
                    var pageView = this.renderingQueue.getHighestPriority(
                        visiblePages, this._pages, scrollAhead);
                ...
                },
                {
                  ...
                  value : function createTextLayerBuilder(textLayerDiv,
                                                          pageIndex, viewport) {
                ...
                },
                {
                  ...
                  value : function createAnnotationLayerBuilder(pageDiv,
                                                                pdfPage) {
                ...
                },
                {
                  ...
                  value : function getPagesOverview() {
                    var pagesOverview = this._pages.map(function(pageView) {
                      var viewport = pageView.pdfPage.getViewport({scale : 1});
                      return {
                    ...
                    var isFirstPagePortrait =
                        (0, _ui_utils.isPortraitOrientation)(pagesOverview[0]);
                    return pagesOverview.map(function(size) {
                      if (isFirstPagePortrait ===
                ...
                {
                  key : "pagesCount",
                  get : function get() { return this._pages.length; }
                },
                {
                  key : "pageViewsReady",
                  get : function get() { return this._pageViewsReady; }
                },
                {
                  key : "currentPageNumber",
                  get : function get() { return this._currentPageNumber; },
                  set : function set(val) {
                ...
                },
                {
                  ...
                  get : function get() { return this._currentScaleValue; },
                  set : function set(val) {
                    if (!this.pdfDocument) {
                      return;
                    }
                ...
                },
                {
                  ...
                  get : function get() {
                    return this.presentationModeState ===
                ...
                {
                  key : "scrollMode",
                  get : function get() { return this._scrollMode; },
                ...
                {
                  key : "spreadMode",
                  get : function get() { return this._spreadMode; },
                  set : function set(mode) {
        ...
        var AnnotationLayerBuilder =
            ...
            function() {
              function AnnotationLayerBuilder(_ref) {
                var pageDiv = _ref.pageDiv, pdfPage = _ref.pdfPage,
                    linkService = _ref.linkService,
                    downloadManager = _ref.downloadManager,
                    _ref$imageResourcesPa = _ref.imageResourcesPath,
                    imageResourcesPath = _ref$imageResourcesPa === void 0
                                             ? ''
              ...
              _createClass(AnnotationLayerBuilder, [
                ...
                {
                  key : "cancel",
                  value : function cancel() { this._cancelled = true; }
                },
                {
                  key : "hide",
                  value : function hide() {
              ...
              _createClass(PDFPageView, [
                ...
                },
                {
                  ...
                  value : function reset() {
                    ...
                    var currentAnnotationNode = keepAnnotations &&
                ...
                },
                {
                  ...
                  value : function update(scale, rotation) {
                    ...
                    if (this.canvas && this.maxCanvasPixels > 0) {
                      ...
                      if ((Math.floor(this.viewport.width) * outputScale.sx |
                           0) *
                ...
                },
                {
                  ...
                  value : function cssTransform(target) {
                    ...
                    var div = this.div;
                    target.style.width = target.parentNode.style.width =
                        div.style.width = Math.floor(width) + 'px';
                    target.style.height = target.parentNode.style.height =
                ...
                {
                  key : "getPagePoint",
                  value : function getPagePoint(
                      x, y) { return this.viewport.convertToPdfPoint(x, y); }
                },
                {
                  key : "draw",
                  value : function draw() {
                    ...
                    if (this.textLayerMode !==
                      ...
                      textLayer = this.textLayerFactory.createTextLayerBuilder(
                          textLayerDiv, this.id - 1, this.viewport,
                          this.textLayerMode ===
                    ...
                    var paintTask = this.renderer === _ui_utils.RendererType.SVG
                    ...
                    var resultPromise = paintTask.promise.then(
                        ...
                        function(reason) { return finishPaintTask(reason); });
                        ...
                        this.annotationLayer =
                            this.annotationLayerFactory
                                .createAnnotationLayerBuilder(
                                    div, pdfPage, this.imageResourcesPath,
                  ...
                  value : function paintOnCanvas(canvasWrapper) {
                    ...
                    var result = {
                      ...
                      onRenderContinue : function onRenderContinue(
                          cont) { cont(); },
                      cancel : function cancel() { renderTask.cancel(); }
                    };
                    ...
                    if (this.useOnlyCssZoom) {
                      var actualSizeViewport =
                          viewport.clone({scale : _ui_utils.CSS_UNITS});
                      outputScale.sx *=
                    ...
                    if (this.maxCanvasPixels > 0) {
                      ...
                      var maxScale =
                          Math.sqrt(this.maxCanvasPixels / pixelsInViewport);
                    ...
                    var sfx =
                        (0, _ui_utils.approximateFraction)(outputScale.sx);
                    var sfy =
                        (0, _ui_utils.approximateFraction)(outputScale.sy);
                    canvas.width = (0, _ui_utils.roundToDivide)(
                        viewport.width * outputScale.sx, sfx[0]);
                    canvas.height = (0, _ui_utils.roundToDivide)(
                        viewport.height * outputScale.sy, sfy[0]);
                    canvas.style.width =
                ...
                },
                {
                  ...
                  value : function paintOnSvg(wrapper) {
                    ...
                    var pdfPage = this.pdfPage;
                    var actualSizeViewport =
                        this.viewport.clone({scale : _ui_utils.CSS_UNITS});
                    var promise = pdfPage.getOperatorList().then(function(
                        opList) {
                      ensureNotCancelled();
                      var svgGfx = new _pdfjsLib.SVGGraphics(pdfPage.commonObjs,
                                                             pdfPage.objs);
                      return svgGfx.getSVG(opList, actualSizeViewport)
                          .then(function(svg) {
                            ensureNotCancelled();
                            _this2.svg = svg;
                    ...
                    return {
                      ...
                      onRenderContinue : function onRenderContinue(
                          cont) { cont(); },
                      cancel : function cancel() { cancelled = true; }
                    };
                  }
                },
                {
                ...
                {
                  key : "width",
                  get : function get() { return this.viewport.width; }
                },
                {
                  key : "height",
                  get : function get() { return this.viewport.height; }
                }
              ]);
        ...
        var TextLayerBuilder =
            ...
            function() {
              function TextLayerBuilder(_ref) {
                var textLayerDiv = _ref.textLayerDiv, eventBus = _ref.eventBus,
                    pageIndex = _ref.pageIndex, viewport = _ref.viewport,
                    _ref$findController = _ref.findController,
                    findController = _ref$findController === void 0
                                         ? null
                                         : _ref$findController,
                    _ref$enhanceTextSelec = _ref.enhanceTextSelection,
                    enhanceTextSelection = _ref$enhanceTextSelec === void 0
                                               ? false
              ...
              _createClass(TextLayerBuilder, [
                  ...
                  value : function _renderMatches(matches) {
                    ...
                    for (var i = i0; i < i1; i++) {
                      ...
                      if (begin.divIdx === end.divIdx) {
                        ...
                        for (var n0 = begin.divIdx + 1, n1 = end.divIdx;
                             n0 < n1; n0++) {
                ...
                },
                {
                  ...
                  value : function _updateMatches() {
                    ...
                    var findController = this.findController,
                        matches = this.matches, pageIdx = this.pageIdx,
                        textContentItemsStr = this.textContentItemsStr,
                        textDivs = this.textDivs;
                    ...
                    for (var i = 0, ii = matches.length; i < ii; i++) {
                      var match = matches[i];
                      var begin =
                          Math.max(clearedUntilDivIdx, match.begin.divIdx);

                      for (var n = begin, end = match.end.divIdx; n <= end;
                           n++) {
                        var div = textDivs[n];
                    ...
                    this.matches =
                        this._convertMatches(pageMatches, pageMatchesLength);
                ...
                },
                {
                  ...
                  value : function _bindEvents() {
                    ...
                    _boundEvents.updateTextLayerMatches = function(evt) {
                      if (evt.pageIndex !== _this2.pageIdx &&
                          evt.pageIndex !== -1) {
                        return;
                      }
                ...
                },
                {
                  ...
                  value : function _bindMouse() {
                    ...
                    div.addEventListener('mousedown', function(evt) {
                      if (_this3.enhanceTextSelection &&
                      ...
                      adjustTop = adjustTop &&
                                  window.getComputedStyle(end).getPropertyValue(
            ...
            function() {
              ...
              _createClass(DefaultTextLayerFactory, [ {
                             ...
                             value : function createTextLayerBuilder(
                                 textLayerDiv, pageIndex, viewport) {
                               var enhanceTextSelection =
                                   arguments.length > 3 &&
        ...
        var SecondaryToolbar =
            ...
            function() {
              function SecondaryToolbar(options, mainContainer, eventBus) {
                ...
                this.buttons = [
                  ...
                  },
                  {
                    ...
                    eventDetails : {mode : _ui_utils.ScrollMode.VERTICAL},
                    close : true
                  },
                  {
                    element : options.scrollHorizontalButton,
                    eventName : 'switchscrollmode',
                    eventDetails : {mode : _ui_utils.ScrollMode.HORIZONTAL},
                    close : true
                  },
                  {
                    element : options.scrollWrappedButton,
                    eventName : 'switchscrollmode',
                    eventDetails : {mode : _ui_utils.ScrollMode.WRAPPED},
                    close : true
                  },
                  {
                    element : options.spreadNoneButton,
                    eventName : 'switchspreadmode',
                    eventDetails : {mode : _ui_utils.SpreadMode.NONE},
                    close : true
                  },
                  {
                    element : options.spreadOddButton,
                    eventName : 'switchspreadmode',
                    eventDetails : {mode : _ui_utils.SpreadMode.ODD},
                    close : true
                  },
                  {
                    element : options.spreadEvenButton,
                    eventName : 'switchspreadmode',
                    eventDetails : {mode : _ui_utils.SpreadMode.EVEN},
                    close : true
                  },
                  {
              ...
              _createClass(SecondaryToolbar, [
                  ...
                  value : function _bindScrollModeListener(buttons) {
                    ...
                    function scrollModeChanged(_ref2) {
                      ...
                      buttons.scrollVerticalButton.classList.toggle(
                          'toggled', mode === _ui_utils.ScrollMode.VERTICAL);
                      buttons.scrollHorizontalButton.classList.toggle(
                          'toggled', mode === _ui_utils.ScrollMode.HORIZONTAL);
                      buttons.scrollWrappedButton.classList.toggle(
                          'toggled', mode === _ui_utils.ScrollMode.WRAPPED);
                  ...
                  value : function _bindSpreadModeListener(buttons) {
                    ...
                    function spreadModeChanged(_ref3) {
                      ...
                      buttons.spreadNoneButton.classList.toggle(
                          'toggled', mode === _ui_utils.SpreadMode.NONE);
                      buttons.spreadOddButton.classList.toggle(
                          'toggled', mode === _ui_utils.SpreadMode.ODD);
                      buttons.spreadEvenButton.classList.toggle(
                          'toggled', mode === _ui_utils.SpreadMode.EVEN);
                    }

                    this.eventBus.on('spreadmodechanged', spreadModeChanged);
                    this.eventBus.on('secondarytoolbarreset', function(evt) {
                      if (evt.source === _this4) {
                        spreadModeChanged({mode : _ui_utils.SpreadMode.NONE});
                      }
                    });
                  }
                },
                ...
                {key : "isOpen", get : function get() { return this.opened; }}
              ]);
        ...
        var PDFSinglePageViewer =
            ...
            function(_BaseViewer) {
              ...
              function PDFSinglePageViewer(options) {
                ...
                _this.eventBus.on(
                    'pagesinit',
                    function(evt) { _this._ensurePageViewVisible(); });
              ...
              _createClass(PDFSinglePageViewer, [
                ...
                },
                {
                  ...
                  get : function get() {
                    return (0, _pdfjsLib.shadow)(
                        this, '_setDocumentViewerElement', this._shadowViewer);
                  }
                },
                {
                  key : "_isScrollModeHorizontal",
              ...
              _createClass(Toolbar, [
                ...
                },
                {
                  ...
                  value : function setPageScale(pageScaleValue, pageScale) {
                    this.pageScaleValue =
                        (pageScaleValue || pageScale).toString();
                ...
                },
                {
                  ...
                  value : function _updateUIState() {
                    ...
                    var pageNumber = this.pageNumber,
                        ...
                        pageScale = this.pageScale, items = this.items;
                      ...
                      if (this.hasPageLabels) {
                        ...
                        this.l10n
                            .get('of_pages', {pagesCount : pagesCount},
                                 'of {{pagesCount}}')
                            .then(function(
                                msg) { items.numPages.textContent = msg; });
                      }
                    ...
                    this.l10n
                        .get('page_scale_percent', {scale : customScale},
                             '{{scale}}%')
                        .then(function(msg) {
                ...
                },
                {
                  ...
                  value : function updateLoadingIndicatorState() {
                    ...
                    pageNumberInput.classList.toggle(
                        PAGE_NUMBER_LOADING_INDICATOR, loading);
                  }
                },
                {
                  ...
                  value : function _adjustScaleWidth() {
                    ...
                    _ui_utils.animationStarted.then(function() {
                      ...
                      if (container.clientWidth > 0) {
                        ...
                        select.setAttribute(
                            'style',
                            'min-width: ' + (width + SCALE_SELECT_PADDING) +
                                'px;');
              ...
              function ViewHistory(fingerprint) {
                ...
                this._initializedPromise =
                    this._readFromStorage().then(function(databaseStr) {
                      ...
                      for (var i = 0, length = database.files.length;
                           i < length; i++) {
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        var GenericExternalServices =
            Object.create(_app.DefaultExternalServices);

        GenericExternalServices.createDownloadManager = function(
            options) { return new _download_manager.DownloadManager(options); };

        GenericExternalServices.createPreferences =
            function() { return new GenericPreferences(); };
              ...
              _createClass(BasePreferences, [
                                ...
                                while (1) {
                                  ...
                                  case 2:
                                    this.prefs = Object.assign(
                                        Object.create(null), this.defaults);
                                    return _context3.abrupt(
                                        "return",
                              ...
                              .wrap(function _callee4$(_context4) {
                                while (1) {
                                  ...
                                  case 2:
                                    ...
                                    throw new Error("Set preference: \"".concat(
                                        name, "\" is undefined."));
                ...
                },
                {
                  ...
                  value : function() {
                              ...
                              .wrap(function _callee5$(_context5) {
                                while (1) {
                                  ...
                                  case 2:
                                    ...
                                    throw new Error("Get preference: \"".concat(
                                        name, "\" is undefined."));
                    ...
                    function get(_x5) { return _get.apply(this, arguments); }
                ...
                },
                {
                  ...
                  value : function() {
                    ...
                    function getAll() { return _getAll.apply(this, arguments); }
            ...
            function() {
              function DownloadManager(_ref) {
                var _ref$disableCreateObj = _ref.disableCreateObjectURL,
                    disableCreateObjectURL = _ref$disableCreateObj === void 0
              ...
              _createClass(DownloadManager, [
                {
                  ...
                  value : function downloadUrl(url, filename) {
                    if (!(0, _pdfjsLib.createValidAbsoluteUrl)(
                  ...
                  value : function downloadData(data, filename, contentType) {
                    if (navigator.msSaveBlob) {
                      return navigator.msSaveBlob(
                          new Blob([ data ], {type : contentType}), filename);
                    }

                    var blobUrl = (0, _pdfjsLib.createObjectURL)(
                        data, contentType, this.disableCreateObjectURL);
            ...
            function() {
              function GenericL10n(lang) {
                ...
                this._ready = new Promise(function(resolve, reject) {
                  webL10n.setLanguage(lang, function() { resolve(webL10n); });
                });
              }
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        document.webL10n = function(window, document, undefined) {
          ...
          function getL10nDictionary() {
            var script =
                document.querySelector('script[type="application/l10n"]');
            ...
            function parseProperties(text, parsedPropertiesCallback) {
              ...
              function loadImport(url, callback) {
                xhrLoadText(
                    url,
                    function(
                        content) { parseRawLines(content, false, callback); },
                    function() {
              ...
              parseRawLines(
                  text, true,
                  function() { parsedPropertiesCallback(dictionary); });
            }
          ...
          function getPluralRules(lang) {
            ...
            function isIn(n, list) { return list.indexOf(n) !== -1; }

            function isBetween(n, start, end) { return start <= n && n <= end; }

            var pluralRules = {
              '0' : function _(n) { return 'other'; },
              '1' : function _(n) {
              ...
              '13' : function _(n) {
                ...
                if (n != 1 && isBetween(n % 10, 0, 1) ||
                    isBetween(n % 10, 5, 9) || isBetween(n % 100, 12, 14))
                  return 'many';
                if (n == 1)
                  return 'one';
                return 'other';
              ...
              '20' : function _(n) {
                if ((isBetween(n % 10, 3, 4) || n % 10 == 9) &&
                    !(isBetween(n % 100, 10, 19) ||
                      isBetween(n % 100, 70, 79) || isBetween(n % 100, 90, 99)))
                  return 'few';
                if (n % 1000000 === 0 && n !== 0)
                  return 'many';
          ...
          function substArguments(str, args, key) {
            ...
            return str.replace(reArgs, function(matched_text, arg) {
              ...
              console.log('argument {{' + arg + '}} for #' + key +
                          ' is undefined.');
              return matched_text;
            });
          }
          ...
          return {
            ...
            getData : function getData() { return gL10nData; },
            getText : function getText() { return gTextData; },
            getLanguage : function getLanguage() { return gLanguage; },
            ...
            getReadyState : function getReadyState() { return gReadyState; },
      ...
      /***/ (function(module, exports, __webpack_require__) {
        ...
        function renderPage(activeServiceOnEntry, pdfDocument, pageNumber,
                            size) {
              ...
              .then(function(pdfPage) {
                var renderContext = {
                  ...
                  viewport : pdfPage.getViewport(
                      {scale : 1, rotation : size.rotation}),
                  intent : 'print'
                };
                return pdfPage.render(renderContext).promise;
              })
              .then(function() { return {width : width, height : height}; });
        }
        ...
        PDFPrintService.prototype = {
          layout : function layout() {
            ...
            this.pageStyleSheet.textContent =
                ...
                '@page { size: ' + pageSize.width + 'pt ' + pageSize.height +
                'pt;}' +
                '}';
          ...
          useRenderedPage : function useRenderedPage(printItem) {
            ...
            if ('toBlob' in scratchCanvas && !this.disableCreateObjectURL) {
              scratchCanvas.toBlob(function(
                  blob) { img.src = _pdfjsLib.URL.createObjectURL(blob); });
            } else {
        ...
        window.print = function print() {
          ...
          try {
            ...
            activeService.renderPages()
                .then(
                    function() { return activeServiceOnEntry.performPrint(); })
                .catch(function() {})
                .then(function() {
        ...
        function renderProgress(index, total, l10n) {
          ...
          l10n.get('print_progress_percent', {progress : progress},
                   progress + '%')
              .then(function(msg) { progressPerc.textContent = msg; });
        }
        ...
        _app.PDFPrintServiceFactory.instance = {
          ...
          createPrintService : function createPrintService(
              pdfDocument, pagesOverview, printContainer, l10n) {
            if (activeService) {
