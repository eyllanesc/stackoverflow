...
var pdfjsWebLibs;
{
  ...
  (function() {
    ...
    (function(root, factory) { factory(root.pdfjsWebOverlayManager = {}); }(
        this, function(exports) {
          var OverlayManager = {
            overlays : {},
            active : null,
            register : function overlayManagerRegister(
                name, element, callerCloseMethod, canForceClose) {
    ...
    (function(root, factory) {
      ...
      var PDFRenderingQueue = function PDFRenderingQueueClosure() {
        ...
        PDFRenderingQueue.prototype = {
          setViewer : function PDFRenderingQueue_setViewer(
          ...
          isHighestPriority : function PDFRenderingQueue_isHighestPriority(
              view) { return this.highestPriorityPage === view.renderingId; },
          renderHighestPriority :
              function PDFRenderingQueue_renderHighestPriority(
          ...
          renderView : function PDFRenderingQueue_renderView(view) {
            ...
            case RenderingStates.INITIAL:
              ...
              var continueRendering =
                  function() { this.renderHighestPriority(); }.bind(this);
    ...
    (function(root, factory) {
      ...
      var Preferences = {
        ...
        _writeToStorage : function preferences_writeToStorage(
            prefObj) { return Promise.resolve(); },
        _readFromStorage : function preferences_readFromStorage(
            prefObj) { return Promise.resolve(); },
    ...
    (function(root, factory) { factory(root.pdfjsWebViewHistory = {}); }(
        this, function(exports) {
            ...
            function ViewHistory(fingerprint, cacheSize) {
              ...
              this.initializedPromise =
                  this._readFromStorage().then(function(databaseStr) {
                    ...
                    var index;
                    for (var i = 0, length = database.files.length; i < length;
                         i++) {
      ...
      DownloadManager.prototype = {
        ...
        downloadData : function DownloadManager_downloadData(data, filename,
          ...
          var blobUrl = pdfjsLib.createObjectURL(
              data, contentType, pdfjsLib.PDFJS.disableCreateObjectURL);
    ...
    (function(root, factory) {
      ...
      var PDFAttachmentViewer = function PDFAttachmentViewerClosure() {
        ...
        PDFAttachmentViewer.prototype = {
          ...
          _bindLink : function PDFAttachmentViewer_bindLink(button, content,
                                                            filename) {
      ...
      var PDFOutlineViewer = function PDFOutlineViewerClosure() {
        ...
        PDFOutlineViewer.prototype = {
          ...
          _dispatchEvent : function PDFOutlineViewer_dispatchEvent(
              outlineCount) {
            this.eventBus.dispatch(
                'outlineloaded', {source : this, outlineCount : outlineCount});
          },
      ...
      var PDFSidebar = function PDFSidebarClosure() {
        ...
        PDFSidebar.prototype = {
          ...
          _addEventListeners : function PDFSidebar_addEventListeners() {
            ...
            self.thumbnailButton.addEventListener(
                'click', function() { self.switchView(SidebarView.THUMBS); });
            self.outlineButton.addEventListener(
                'click', function() { self.switchView(SidebarView.OUTLINE); });
            self.outlineButton.addEventListener(
                'dblclick',
                function() { self.pdfOutlineViewer.toggleOutlineTree(); });
            self.attachmentsButton.addEventListener(
                'click',
                function() { self.switchView(SidebarView.ATTACHMENTS); });
    ...
    (function(root, factory) {
      ...
      function watchScroll(viewAreaElement, callback) {
        var debounceScroll = function debounceScroll(evt) {
          ...
          rAF =
              window.requestAnimationFrame(function viewAreaElementScrolled() {
                rAF = null;
      ...
      var localized = new Promise(function(resolve, reject) {
        ...
        window.addEventListener('localized',
                                function localized(evt) { resolve(); });
      });
      var EventBus = function EventBusClosure() {
        function EventBus() { this._listeners = Object.create(null); }
        EventBus.prototype = {
      ...
      function attachDOMEventsToEventBus(eventBus) {
        ...
        eventBus.on('pagerendered', function(e) {
          ...
          event.initCustomEvent(
              'pagerendered', true, true,
              {pageNumber : e.pageNumber, cssTransform : e.cssTransform});
        ...
        eventBus.on('presentationmodechanged', function(e) {
          var event = document.createEvent('CustomEvent');
          event.initCustomEvent(
              'presentationmodechanged', true, true,
              {active : e.active, switchInProgress : e.switchInProgress});
          window.dispatchEvent(event);
        });
        ...
        PasswordPrompt.prototype = {
          open : function PasswordPrompt_open() {
            OverlayManager.open(this.overlayName).then(function() {
              ...
              this.input.focus();
              var promptString =
                  mozL10n.get('password_label', null,
                              'Enter the password to open this PDF file.');
              if (this.reason ===
                  pdfjsLib.PasswordResponses.INCORRECT_PASSWORD) {
                promptString =
                    mozL10n.get('password_invalid', null,
      ...
      var PDFDocumentProperties = function PDFDocumentPropertiesClosure() {
        function PDFDocumentProperties(options) {
          ...
          this.dataAvailablePromise = new Promise(
              function(resolve) { this.resolveDataAvailable = resolve; }.bind(
                  this));
          OverlayManager.register(this.overlayName, this.container,
                                  this.close.bind(this));
        }
        PDFDocumentProperties.prototype = {
          open : function PDFDocumentProperties_open() {
            Promise
                ...
                .then(function() { this._getProperties(); }.bind(this));
          },
        ...
        PDFFindController.prototype = {
          reset : function PDFFindController_reset() {
            ...
            this.firstPagePromise = new Promise(
                function(resolve) { this.resolveFirstPage = resolve; }.bind(
                    this));
          },
          ...
          calcFindWordMatch : function PDFFindController_calcFindWordMatch(
            ...
            for (var i = 0, len = queryArray.length; i < len; i++) {
              ...
              while (true) {
                matchIdx =
                    pageContent.indexOf(subquery, matchIdx + subqueryLen);
                if (matchIdx === -1) {
                  break;
                }
          ...
          extractText : function PDFFindController_extractText() {
            ...
            for (var i = 0; i < numPages; i++) {
              this.extractTextPromises.push(new Promise(function(
                  resolve) { extractTextPromisesResolves.push(resolve); }));
            }
            var self = this;
          ...
          executeCommand : function PDFFindController_executeCommand(cmd,
                                                                     state) {
          ...
          nextMatch : function PDFFindController_nextMatch() {
            ...
            if (offset.matchIdx !== null) {
              ...
              if (!previous && offset.matchIdx + 1 < numPageMatches ||
                ...
                this.hadMatch = true;
                offset.matchIdx =
                    previous ? offset.matchIdx - 1 : offset.matchIdx + 1;
          ...
          updateUIState : function PDFFindController_updateUIState(state,
                                                                   previous) {
    ...
    (function(root, factory) {
      ...
      var PDFPresentationMode = function PDFPresentationModeClosure() {
        function PDFPresentationMode(options) {
          ...
          if (contextMenuItems) {
            contextMenuItems.contextFirstPage.addEventListener(
                'click', function PDFPresentationMode_contextFirstPageClick(e) {
                  this.contextMenuOpen = false;
                  this.eventBus.dispatch('firstpage');
                }.bind(this));
            contextMenuItems.contextLastPage.addEventListener(
                'click', function PDFPresentationMode_contextLastPageClick(e) {
                  this.contextMenuOpen = false;
        ...
        PDFPresentationMode.prototype = {
          ...
          _notifyStateChange :
              function PDFPresentationMode_notifyStateChange() {
          ...
          _setSwitchInProgress :
              function PDFPresentationMode_setSwitchInProgress() {
                ...
                this.switchInProgress =
                    setTimeout(function switchInProgressTimeout() {
          ...
          _addWindowListeners :
              function PDFPresentationMode_addWindowListeners() {
    ...
    (function(root, factory) {
      ...
      var PDFThumbnailView = function PDFThumbnailViewClosure() {
        ...
        function PDFThumbnailView(options) {
          ...
          anchor.title =
              mozL10n.get('thumb_page_title', {page : id}, 'Page {{page}}');
        ...
        PDFThumbnailView.prototype = {
          ...
          update : function PDFThumbnailView_update(rotation) {
            ...
            var totalRotation = (this.rotation + this.pdfPageRotate) % 360;
            this.viewport =
                this.viewport.clone({scale : 1, rotation : totalRotation});
            this.reset();
          },
          ...
          _convertCanvasToImage :
              function PDFThumbnailView_convertCanvasToImage() {
                ...
                var ariaLabel =
                    mozL10n.get('thumb_page_canvas', {page : this.pageId},
          ...
          draw : function PDFThumbnailView_draw() {
            ...
            var renderContext = {canvasContext : ctx, viewport : drawViewport};
            var renderTask = this.renderTask =
                this.pdfPage.render(renderContext);
            renderTask.onContinue = renderContinueCallback;
            renderTask.promise.then(
                function
                    pdfPageRenderCallback() { thumbnailDrawCallback(null); },
                function pdfPageRenderError(
                    error) { thumbnailDrawCallback(error); });
            return promise;
          },
          setImage : function PDFThumbnailView_setImage(pageView) {
            ...
            while (reducedWidth > 2 * canvas.width) {
              reducedImageCtx.drawImage(reducedImage, 0, 0, reducedWidth,
                                        reducedHeight, 0, 0, reducedWidth >> 1,
                                        reducedHeight >> 1);
              reducedWidth >>= 1;
              reducedHeight >>= 1;
            }
          ...
          setPageLabel : function PDFThumbnailView_setPageLabel(label) {
            ...
            this.anchor.title = mozL10n.get(
                'thumb_page_title', {page : this.pageId}, 'Page {{page}}');
            if (this.renderingState !== RenderingStates.FINISHED) {
              return;
            }
            var ariaLabel =
      ...
      var SecondaryToolbar = function SecondaryToolbarClosure() {
        ...
        SecondaryToolbar.prototype = {
          ...
          _bindHandToolListener :
              function SecondaryToolbar_bindHandToolListener(
                ...
                this.eventBus.on('handtoolchanged', function(e) {
                  ...
                  if (isHandToolActive) {
                    toggleHandToolButton.title = mozL10n.get(
                        'hand_tool_disable.title', null, 'Disable hand tool');
                    toggleHandToolButton.firstElementChild.textContent =
                        mozL10n.get('hand_tool_disable_label', null,
                                    'Disable hand tool');
                  } else {
                    toggleHandToolButton.title = mozL10n.get(
                        'hand_tool_enable.title', null, 'Enable hand tool');
                    toggleHandToolButton.firstElementChild.textContent =
                        mozL10n.get('hand_tool_enable_label', null,
                                    'Enable hand tool');
                  }
                });
              },
          ...
          _setMaxHeight : function SecondaryToolbar_setMaxHeight() {
            ...
            this.toolbarButtonContainer.setAttribute(
                'style',
                'max-height: ' + (this.containerHeight - SCROLLBAR_PADDING) +
                    'px;');
      ...
      var Toolbar = function ToolbarClosure() {
        ...
        Toolbar.prototype = {
          ...
          _bindListeners : function Toolbar_bindClickListeners() {
            ...
            var self = this;
            var items = this.items;
            items.previous.addEventListener(
                'click', function() { eventBus.dispatch('previouspage'); });
            items.next.addEventListener(
                'click', function() { eventBus.dispatch('nextpage'); });
            items.zoomIn.addEventListener(
                'click', function() { eventBus.dispatch('zoomin'); });
            items.zoomOut.addEventListener(
                'click', function() { eventBus.dispatch('zoomout'); });
            ...
            items.presentationModeButton.addEventListener(
                'click',
                function(e) { eventBus.dispatch('presentationmode'); });
            items.openFile.addEventListener(
                'click', function(e) { eventBus.dispatch('openfile'); });
            items.print.addEventListener(
                'click', function(e) { eventBus.dispatch('print'); });
            items.download.addEventListener(
                'click', function(e) { eventBus.dispatch('download'); });
            ...
            function selectScaleOption(value, scale) {
              ...
              if (!predefinedValueFound) {
                ...
                items.customScaleOption.textContent = mozL10n.get(
                    'page_scale_percent', {scale : customScale}, '{{scale}}%');
            ...
            if (resetNumPages) {
              if (this.hasPageLabels) {
                ...
                items.numPages.textContent = mozL10n.get(
                    'of_pages', {pagesCount : pagesCount}, 'of {{pagesCount}}');
              }
      ...
      var PDFFindBar = function PDFFindBarClosure() {
        function PDFFindBar(options) {
          ...
          this.findField.addEventListener(
              'input', function() { self.dispatchEvent(''); });
          ...
          this.findPreviousButton.addEventListener(
              'click', function() { self.dispatchEvent('again', true); });
          this.findNextButton.addEventListener(
              'click', function() { self.dispatchEvent('again', false); });
          this.highlightAll.addEventListener(
              'click',
              function() { self.dispatchEvent('highlightallchange'); });
          this.caseSensitive.addEventListener(
              'click',
              function() { self.dispatchEvent('casesensitivitychange'); });
        }
          ...
          updateUIState : function PDFFindBar_updateUIState(state, previous,
            ...
            case FindStates.FIND_WRAPPED:
              if (previous) {
                ...
                findMsg =
                    mozL10n.get('find_reached_bottom', null,
      ...
      PDFHistory.prototype = {
        initialize : function pdfHistoryInitialize(fingerprint) {
          ...
          self.eventBus.on(
              ...
              function(e) { self.isViewerInPresentationMode = e.active; });
        },
        ...
        _isStateObjectDefined : function pdfHistory_isStateObjectDefined(
            state) {
          return state && state.uid >= 0 && state.fingerprint &&
                         this.fingerprint === state.fingerprint &&
        ...
        _updatePreviousBookmark : function pdfHistory_updatePreviousBookmark() {
          if (this.updatePreviousBookmark && this.currentBookmark &&
              this.currentPage) {
        ...
        push : function pdfHistoryPush(params, isInitialBookmark) {
          ...
          if (params.dest && !params.hash) {
            params.hash = this.current.hash && this.current.dest &&
                              ...
                              ? this.current.hash
                              : this.linkService.getDestinationHash(params.dest)
                                    .split('#')[1];
          }
          if (params.page) {
            params.page |= 0;
        ...
        back : function pdfHistoryBack() { this.go(-1); },
        forward : function pdfHistoryForward() { this.go(1); },
    ...
    (function(root, factory) {
      ...
      function isPageNumber(str) { return PageNumberRegExp.test(str); }
      var PDFLinkService = function PDFLinkServiceClosure() {
        ...
        PDFLinkService.prototype = {
          setDocument : function PDFLinkService_setDocument(pdfDocument,
                                                            baseUrl) {
            this.baseUrl = baseUrl;
            this.pdfDocument = pdfDocument;
            this._pagesRefCache = Object.create(null);
          },
          setViewer : function PDFLinkService_setViewer(
              pdfViewer) { this.pdfViewer = pdfViewer; },
          setHistory : function PDFLinkService_setHistory(
            ...
            var goToDestination = function(destRef) {
              ...
              if (pageNumber) {
                ...
                self.pdfViewer.scrollPageIntoView(
                    {pageNumber : pageNumber, destArray : dest});
                if (self.pdfHistory) {
                  self.pdfHistory.push(
                      {dest : dest, hash : destString, page : pageNumber});
                }
              } else {
                self.pdfDocument.getPageIndex(destRef)
          ...
          getDestinationHash : function PDFLinkService_getDestinationHash(
              dest) {
            if (typeof dest === 'string') {
              return this.getAnchorUrl(
                  '#' + (isPageNumber(dest) ? 'nameddest=' : '') +
                  escape(dest));
            }
          ...
          getAnchorUrl : function PDFLinkService_getAnchorUrl(
                  ...
                  if (zoomArg === 'Fit' || zoomArg === 'FitB') {
                    ...
                    if (zoomArgs.length !== 5) {
                      ...
                      dest = [
                        ...
                        zoomArgs[2] | 0, zoomArgs[3] | 0, zoomArgs[4] | 0
                      ];
                    }
                  } else {
          ...
          cachePageRef : function PDFLinkService_cachePageRef(pageNum,
                                                              pageRef) {
            var refStr = pageRef.num + ' ' + pageRef.gen + ' R';
            this._pagesRefCache[refStr] = pageNum;
          },
          _cachedPageNumber : function PDFLinkService_cachedPageNumber(
              pageRef) {
            var refStr = pageRef.num + ' ' + pageRef.gen + ' R';
        ...
        function isValidExplicitDestination(dest) {
          ...
          var page = dest[0];
          if (!(typeof page === 'object' && typeof page.num === 'number' &&
                (page.num | 0) === page.num && typeof page.gen === 'number' &&
                (page.gen | 0) === page.gen) &&
      ...
      var PDFPageView = function PDFPageViewClosure() {
        ...
        PDFPageView.prototype = {
          setPdfPage : function PDFPageView_setPdfPage(pdfPage) {
            ...
            var totalRotation = (this.rotation + this.pdfPageRotate) % 360;
            this.viewport =
                pdfPage.getViewport(this.scale * CSS_UNITS, totalRotation);
          ...
          update : function PDFPageView_update(scale, rotation) {
            ...
            this.viewport = this.viewport.clone(
                {scale : this.scale * CSS_UNITS, rotation : totalRotation});
            if (this.svg) {
              this.cssTransform(this.svg, true);
              this.eventBus.dispatch(
                  'pagerendered',
                  {source : this, pageNumber : this.id, cssTransform : true});
              return;
            }
          ...
          cssTransform : function PDFPageView_transform(target,
                                                        redrawAnnotations) {
          ...
          getPagePoint : function PDFPageView_getPagePoint(
          ...
          draw : function PDFPageView_draw() {
            ...
            var finishPaintTask = function finishPaintTask(error) {
              ...
              self.eventBus.dispatch(
                  'pagerendered',
                  {source : self, pageNumber : self.id, cssTransform : false});
              if (error) {
              ...
              if (!this.annotationLayer) {
                this.annotationLayer =
                    this.annotationLayerFactory.createAnnotationLayerBuilder(
                        div, pdfPage, this.renderInteractiveForms);
              }
              this.annotationLayer.render(this.viewport, 'display');
            }
          ...
          paintOnCanvas : function(canvasWrapper) {
            ...
            var result = {
              promise : promise,
              onRenderContinue : function(cont) { cont(); },
              cancel : function() { renderTask.cancel(); }
            };
            var self = this;
            var pdfPage = this.pdfPage;
            var viewport = this.viewport;
    ...
    (function(root, factory) {
      ...
      var PDFThumbnailViewer = function PDFThumbnailViewerClosure() {
        ...
        PDFThumbnailViewer.prototype = {
          ...
          getThumbnail : function PDFThumbnailViewer_getThumbnail(
              index) { return this.thumbnails[index]; },
          ...
          forceRendering : function() {
            ...
            var thumbView = this.renderingQueue.getHighestPriority(
                visibleThumbs, this.thumbnails, this.scroll.down);
            if (thumbView) {
        ...
        TextLayerBuilder.prototype = {
          ...
          renderMatches : function TextLayerBuilder_renderMatches(matches) {
            ...
            function appendTextToDiv(divIdx, fromOffset, toOffset, className) {
              ...
              var content =
                  bidiTexts[divIdx].str.substring(fromOffset, toOffset);
            ...
            for (var i = i0; i < i1; i++) {
              ...
              if (begin.divIdx === end.divIdx) {
                ...
                for (var n0 = begin.divIdx + 1, n1 = end.divIdx; n0 < n1;
                     n0++) {
          ...
          _bindMouse : function TextLayerBuilder_bindMouse() {
            ...
            div.addEventListener('mousedown', function(e) {
              ...
              adjustTop =
                  adjustTop && window.getComputedStyle(end).getPropertyValue(
                                   '-moz-user-select') !== 'none';
              if (adjustTop) {
                var divBounds = div.getBoundingClientRect();
                var r =
                    Math.max(0, (e.pageY - divBounds.top) / divBounds.height);
    ...
    (function(root, factory) {
      factory(root.pdfjsWebPDFViewer = {}, root.pdfjsWebUIUtils,
              ...
              root.pdfjsWebAnnotationLayerBuilder, root.pdfjsWebPDFLinkService,
      ...
      var PDFViewer = function pdfViewer() {
        ...
        function PDFViewer(options) {
          ...
          this.scroll =
              watchScroll(this.container, this._scrollUpdate.bind(this));
        ...
        PDFViewer.prototype = {
          ...
          getPageView : function(index) { return this._pages[index]; },
          get pageViewsReady() { return this._pageViewsReady; },
          ...
          setDocument : function(pdfDocument) {
            ...
            var pagesPromise = new Promise(function(
                resolve) { resolvePagesPromise = resolve; });
            this.pagesPromise = pagesPromise;
            pagesPromise.then(function() {
              self._pageViewsReady = true;
              self.eventBus.dispatch('pagesloaded',
                                     {source : self, pagesCount : pagesCount});
            });
            var isOnePageRenderedResolved = false;
            var resolveOnePageRendered = null;
            var onePageRendered = new Promise(function(
                resolve) { resolveOnePageRendered = resolve; });
            this.onePageRendered = onePageRendered;
            var bindOnAfterAndBeforeDraw = function(pageView) {
              pageView.onBeforeDraw = function
              pdfViewLoadOnBeforeDraw() { self._buffer.push(this); };
            ...
            return firstPagePromise.then(function(pdfPage) {
              ...
              onePageRendered.then(function() {
                if (!pdfjsLib.PDFJS.disableAutoFetch) {
                  ...
                  for (var pageNum = 1; pageNum <= pagesCount; ++pageNum) {
                    pdfDocument.getPage(pageNum).then(function(pageNum,
                                                               pdfPage) {
          ...
          _setScaleUpdatePages : function pdfViewer_setScaleUpdatePages(
            ...
            if (!noScroll) {
              ...
              if (this._location &&
                ...
                dest = [
                  null, {name : 'XYZ'}, this._location.left, this._location.top,
                  null
                ];
              }
          ...
          _setScale : function PDFViewer_setScale(value, noScroll) {
            ...
            if (scale > 0) {
              ...
              case 'auto':
                ...
                var horizontalScale =
                    isLandscape ? Math.min(pageHeightScale, pageWidthScale)
                                : pageWidthScale;
          ...
          _updateLocation : function(firstPage) {
            ...
            var container = this.container;
            var topLeft =
                currentPageView.getPagePoint(container.scrollLeft - firstPage.x,
          ...
          update : function PDFViewer_update() {
            ...
            var suggestedCacheSize =
                Math.max(DEFAULT_CACHE_SIZE, 2 * visiblePages.length + 1);
          ...
          focus : function() { this.container.focus(); },
          ...
          get isHorizontalScrollbarEnabled() {
            return this.isInPresentationMode ? false
          ...
          _ensurePdfPageLoaded : function(pageView) {
            ...
            var promise =
                this.pdfDocument.getPage(pageNumber).then(function(pdfPage) {
                  pageView.setPdfPage(pdfPage);
                  this._pagesRequests[pageNumber] = null;
                  return pdfPage;
                }.bind(this));
          ...
          forceRendering : function(currentlyVisiblePages) {
            ...
            var pageView = this.renderingQueue.getHighestPriority(
                visiblePages, this._pages, this.scroll.down);
            if (pageView) {
              this._ensurePdfPageLoaded(pageView).then(
                  function() { this.renderingQueue.renderView(pageView); }.bind(
                      this));
              return true;
            }
            return false;
          ...
          createTextLayerBuilder : function(textLayerDiv, pageIndex, viewport,
            ...
            return new TextLayerBuilder({
              ...
              pageIndex : pageIndex,
              viewport : viewport,
              findController : this.isInPresentationMode ? null
                                                         : this.findController,
              enhanceTextSelection :
          ...
          setFindController : function(
              findController) { this.findController = findController; },
    ...
    (function(root, factory) {
      factory(root.pdfjsWebApp = {}, root.pdfjsWebUIUtils,
              ...
              root.pdfjsWebDOMEvents, root.pdfjsWebPDFJS);
                     ...
                     pdfRenderingQueueLib, pdfLinkServiceLib,
                     pdfOutlineViewerLib, overlayManagerLib,
                     pdfAttachmentViewerLib, pdfFindControllerLib,
                     pdfFindBarLib, domEventsLib, pdfjsLib) {
      ...
      var DefaultExernalServices = {
        ...
        createDownloadManager :
            function() { return new downloadManagerLib.DownloadManager(); },
      ...
      var PDFViewerApplication = {
        ...
        initialize : function pdfViewInitialize(appConfig) {
          ...
          return this._readPreferences()
              .then(function() { return self._initializeViewerComponents(); })
              .then(function() {
                self.bindEvents();
                self.bindWindowEvents();
                localized.then(
                    function() { self.eventBus.dispatch('localized'); });
        ...
        _readPreferences : function() {
          ...
          return Promise
              .all([
                ...
                Preferences.get('sidebarViewOnLoad')
                ...
                Preferences.get('showPreviousViewOnLoad')
                    .then(function resolved(value) {
                      self.viewerPrefs['showPreviousViewOnLoad'] = value;
                    }),
                Preferences.get('defaultZoomValue')
                    .then(function resolved(value) {
                      self.viewerPrefs['defaultZoomValue'] = value;
                    }),
                Preferences.get('enhanceTextSelection')
                    .then(function resolved(value) {
                      self.viewerPrefs['enhanceTextSelection'] = value;
                    }),
                Preferences.get('disableTextLayer')
                    .then(function resolved(value) {
                ...
                Preferences.get('disableAutoFetch')
                    .then(function resolved(
                        value) { PDFJS.disableAutoFetch = value; }),
                Preferences.get('disableFontFace')
                    .then(function resolved(value) {
                ...
                Preferences.get('useOnlyCssZoom')
                    .then(function resolved(
                        value) { PDFJS.useOnlyCssZoom = value; }),
                Preferences.get('externalLinkTarget')
                    .then(function resolved(value) {
                ...
                Preferences.get('renderInteractiveForms')
                    .then(function resolved(value) {
                      self.viewerPrefs['renderInteractiveForms'] = value;
                    }),
                Preferences.get('disablePageLabels')
                    .then(function resolved(value) {
        ...
        _initializeViewerComponents : function() {
          ...
          return new Promise(function(resolve, reject) {
            ...
            self.findController =
                new PDFFindController({pdfViewer : self.pdfViewer});
            ...
            self.handTool =
                new HandTool({container : container, eventBus : eventBus});
            self.pdfDocumentProperties =
                new PDFDocumentProperties(appConfig.documentProperties);
            self.toolbar = new Toolbar(appConfig.toolbar, container, eventBus);
            self.secondaryToolbar = new SecondaryToolbar(
                appConfig.secondaryToolbar, container, eventBus);
        ...
        open : function pdfViewOpen(file, args) {
          ...
          loadingTask.onPassword = function passwordNeeded(updateCallback,
                                                           reason) {
          ...
          return loadingTask.promise.then(
              function getDocumentCallback(
                  pdfDocument) { self.load(pdfDocument, scale); },
              function getDocumentError(exception) {
                var message = exception && exception.message;
                var loadingErrorMessage =
                    mozL10n.get('loading_error', null,
                                'An error occurred while loading the PDF.');
                if (exception instanceof pdfjsLib.InvalidPDFException) {
                  loadingErrorMessage =
                      mozL10n.get('invalid_file_error', null,
                                  'Invalid or corrupted PDF file.');
                } else if (exception instanceof pdfjsLib.MissingPDFException) {
                  loadingErrorMessage = mozL10n.get('missing_file_error', null,
                                                    'Missing PDF file.');
                } else if (exception instanceof
                           pdfjsLib.UnexpectedResponseException) {
                  loadingErrorMessage =
                      mozL10n.get('unexpected_response_error', null,
        ...
        download : function pdfViewDownload() {
          ...
          downloadManager.onerror = function(
              err) { PDFViewerApplication.error('PDF failed to download.'); };
          if (!this.pdfDocument) {
            downloadByUrl();
            return;
          }
        ...
        error : function pdfViewError(message, moreInfo) {
          var moreInfoText =
              mozL10n.get('error_version_info', {
          ...
          firstPagePromise.then(function(pdfPage) {
            ...
            store.initializedPromise.then(
                function resolved() {
                  ...
                  self.setInitialView(
                      storedHash, {scale : scale, sidebarView : sidebarView});
        ...
        bindWindowEvents : function pdfViewBindWindowEvents() {
          ...
          window.addEventListener(
              'resize',
              function windowResize() { eventBus.dispatch('resize'); });
          ...
          window.addEventListener(
              'afterprint',
              function windowAfterPrint() { eventBus.dispatch('afterprint'); });
      ...
      function webViewerInitialized() {
        ...
        appConfig.sidebar.toggleButton.addEventListener(
            'click', function() { PDFViewerApplication.pdfSidebar.toggle(); });
        Promise.all(waitForBeforeOpening)
            .then(function() { webViewerOpenFileViaURL(file); })
            .catch(function(reason) {
      ...
      function webViewerPageRendered(e) {
        ...
        if (pageView.error) {
          PDFViewerApplication.error(
              mozL10n.get('rendering_error', null,
      ...
      function webViewerPresentationModeChanged(e) {
        ...
        PDFViewerApplication.pdfViewer.presentationModeState =
            switchInProgress ? PresentationModeState.CHANGING
                             : active ? PresentationModeState.FULLSCREEN
      ...
      function webViewerUpdateViewarea(e) {
        ...
        PDFViewerApplication.pdfHistory.updateCurrentBookmark(
            location.pdfOpenParams, location.pageNumber);
      ...
      function webViewerResize() {
        ...
        if (currentScaleValue === 'auto' || currentScaleValue === 'page-fit' ||
      ...
      function webViewerWheel(evt) {
        ...
        if (evt.ctrlKey || evt.metaKey) {
          ...
          zoomDisabledTimeout =
              setTimeout(function() { zoomDisabled = false; }, 1000);
        }
      }
      ...
      function webViewerKeyDown(evt) {
        ...
        if (curElementTagName === 'INPUT' || curElementTagName === 'TEXTAREA' ||
    ...
    (function(root, factory) {
      factory(root.pdfjsWebPDFPrintService = {}, root.pdfjsWebUIUtils,
              root.pdfjsWebOverlayManager, root.pdfjsWebApp,
              root.pdfjsWebPDFJS);
        ...
        renderPages : function() {
          ...
          var renderNextPage = function(resolve, reject) {
            ...
            renderPage(this, this.pdfDocument, index + 1,
                ...
                .then(function() { renderNextPage(resolve, reject); }, reject);
          }.bind(this);
      ...
      function renderProgress(index, total) {
        ...
        progressPerc.textContent = mozL10n.get(
            'print_progress_percent', {progress : progress}, progress + '%');
      }
      ...
      PDFPrintServiceFactory.instance = {
        ...
        createPrintService : function(pdfDocument, pagesOverview,
                                      printContainer) {
          if (activeService) {
            throw new Error('The print service is created and active.');
          }
          activeService =
              new PDFPrintService(pdfDocument, pagesOverview, printContainer);
