...
function addMarker(lat, lon, city, url) {
  ...
  newmarker['infowindow'] = new google.maps.InfoWindow({content : url});
  google.maps.event.addListener(
      newmarker, 'click', function() { this['infowindow'].open(map, this); });
}
...
function initialize() {
  ...
  var marker = new google.maps.Marker(
      {position : latLng, title : 'Point A', map : map, draggable : true});
  ...
  google.maps.event.addListener(
      marker, 'dragstart', function() { updateMarkerAddress('Dragging...'); });
