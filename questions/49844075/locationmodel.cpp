...
QQmlListProperty<Location> LocationModel::locations()
{
    return QQmlListProperty<Location>(this, this,
                                      &LocationModel::appendLocation,
                                      &LocationModel::locationCount,
                                      &LocationModel::location,
                                      &LocationModel::clearLocations);
}
...
Location *LocationModel::location(int ix) const
{
    return m_locations.at(ix);
}
...
void LocationModel::appendLocation(QQmlListProperty<Location> *list, Location *p)
{
