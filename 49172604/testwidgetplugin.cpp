...
TestWidgetPlugin::TestWidgetPlugin(QObject *parent)
    : QObject(parent)
{
    m_initialized = false;
}
...
bool TestWidgetPlugin::isInitialized() const
{
...
QString TestWidgetPlugin::name() const
{
    return QLatin1String("TestWidget");
}
...
QString TestWidgetPlugin::whatsThis() const
{
    return QLatin1String("");
}

bool TestWidgetPlugin::isContainer() const
{
    return false;
}
...
{
    return QLatin1String("<widget class=\"TestWidget\" name=\"testWidget\">\n</widget>\n");
}
